// tracks "the player recently received real client activity" for App.tsx's
 ...
 * for IDLE_TIMEOUT_MS - App.tsx maps this to spin speed and hides the
 * spinner entirely at null. */
export function activityRamp(): number | null {
