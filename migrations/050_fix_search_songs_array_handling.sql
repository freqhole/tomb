-- Fix search_songs function to properly handle null array parameters
-- This addresses the "cannot extract elements from a scalar" error when array parameters are null

-- Drop the existing search_songs function
DROP FUNCTION IF EXISTS search_songs CASCADE;

-- Recreate search_songs function with proper null array handling
...
COMMENT ON FUNCTION search_songs IS 'Enhanced music search function with album-first sorting and fixed array parameter handling - properly handles null array parameters to prevent scalar extraction errors';
