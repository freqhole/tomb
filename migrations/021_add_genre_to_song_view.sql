-- add genre name and sub_genres to song_query_view
-- this allows us to show genre information when displaying songs without extra queries
...
-- also update playlist_song_query_view to include genre info
