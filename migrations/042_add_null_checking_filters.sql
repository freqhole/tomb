-- Add NULL checking filter support to search_songs function
-- This migration adds explicit IS NULL / IS NOT NULL checks for common fields
...
COMMENT ON FUNCTION search_songs IS 'Enhanced song search with total count, sort direction support, and explicit NULL checking filters for better handling of missing metadata';
