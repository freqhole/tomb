-- update song thumbnail_blob_id to use fallback hierarchy: song image → album image → artist image
-- this ensures every song has the best available image for display
