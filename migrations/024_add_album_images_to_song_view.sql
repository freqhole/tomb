-- add album_images field to song query views so albums can display their own images
-- this allows album sections in artist detail view to show album artwork
