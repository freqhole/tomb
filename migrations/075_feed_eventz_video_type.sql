-- migration 075: add 'video' feed event type (new video added to library)
--
-- mirrors 'album' - fired once per video import, denormalizing the video's
-- title/description/poster so the feed can render without a join.
--
...
-- new index for the 'video' (new video added) feed event type
