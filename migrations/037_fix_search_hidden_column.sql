-- Fix search function to remove reference to non-existent is_hidden column
-- This migration fixes the search_songs function that was referencing s.is_hidden which doesn't exist

-- Drop and recreate the search_songs function without the is_hidden reference
DROP FUNCTION IF EXISTS search_songs(
    TEXT, TEXT, TEXT, TEXT, BOOLEAN, TEXT, BOOLEAN, TEXT, TEXT, TEXT, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, BIGINT, INTEGER, INTEGER, INTEGER, INTEGER, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, TEXT[], TEXT[], TEXT[], TEXT[], TEXT[], TEXT[], TEXT, TEXT[], INTEGER, INTEGER, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ, TEXT, TEXT[], TEXT, TEXT, TEXT, BOOLEAN, BOOLEAN, TEXT, JSONB, INTEGER, INTEGER, TEXT
);

-- Enhanced search_songs function without is_hidden reference
...
COMMENT ON FUNCTION search_songs IS 'Enhanced song search with comprehensive filter support, fixed to remove non-existent is_hidden column reference';
