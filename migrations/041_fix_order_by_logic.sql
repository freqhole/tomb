-- Fix ORDER BY logic in search_songs function with cleaner, simpler approach
-- This migration simplifies the sorting logic to be more predictable and reliable
...
-- Enhanced search_songs function with simplified sort direction support
...
COMMENT ON FUNCTION search_songs IS 'Enhanced song search with total count and clean sort direction support using explicit ASC/DESC clauses';
