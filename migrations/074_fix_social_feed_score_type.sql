-- Fix score column type mismatch in get_social_feed_items function
-- This migration fixes the numeric vs double precision type mismatch

-- Drop and recreate get_social_feed_items function with proper type casting
...
COMMENT ON FUNCTION get_social_feed_items IS 'Returns social feed items based on user activity from media_events table (fixed score type)';
