...
:::note[headsup]
please see the full [freqhole-config.toml](https://github.com/freqhole/tomb/blob/main/assets/config/freqhole-config.toml) file to understand all the options available
:::
...
| Windows (app) | `%APPDATA%\net.freqhole.charnel\freqhole-config.toml`                     |
