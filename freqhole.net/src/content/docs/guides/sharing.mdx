...
freqhole lets you share your music + video library with friends via peer-to-peer connections — no port forwarding or public IP needed.
...
- video metadata (title, series, season, duration)
- album artwork + video posters
- stream access (can play music + video)
- search functionality
- feed of server activity: new media, playback sessions, favorites & ratings
