...
regular maintenance keeps your library clean and the database efficient.
...
downloads updates automatically and prompts to restart.
...
- SSD essential
- WAL mode (default) handles contention well
