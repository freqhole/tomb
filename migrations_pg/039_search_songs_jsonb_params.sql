-- Convert search_songs function to use JSONB parameter
-- This migration replaces the 57-parameter version with a clean single JSONB parameter approach

-- drop the existing search_songs function
DROP FUNCTION IF EXISTS search_songs CASCADE;

-- recreate search_songs function with single JSONB parameter
...
COMMENT ON FUNCTION search_songs IS 'search songs with jsonb parameter - user-aware and much easier to use than positional parameters';
