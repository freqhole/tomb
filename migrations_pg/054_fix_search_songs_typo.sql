-- Fix search_songs function typo and DISTINCT ON issue
-- Hotfix for p_bmp_max typo and DISTINCT ON/ORDER BY incompatibility

-- Drop the existing search_songs function
DROP FUNCTION IF EXISTS search_songs CASCADE;

-- Recreate search_songs function with fixes
...
COMMENT ON FUNCTION search_songs IS 'Enhanced music search function with sub_genres support, smart album grouping, and comprehensive filtering (fixed typos and DISTINCT ON issue)';
