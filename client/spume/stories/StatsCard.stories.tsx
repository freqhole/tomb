...
export const Interactive: Story = {
  render: () => {
    ...
    void setTotalDuration; // may be used for dynamic updates
    void setAvgRating; // may be used for dynamic updates
    ...
    return (
      <div class="p-6 bg-[var(--color-bg-primary)] rounded-lg">
        <div class="mb-6">
          ...
          <p class="text-[var(--color-text-secondary)] text-sm">artist statistics</p>
        </div>
  ...
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)] rounded-lg">
      <h3 class="text-[var(--color-text-primary)] text-2xl font-bold mb-4">
        {mockArtists.find((a) => a.name === "Led Zeppelin")?.name || mockArtists[2].name}
      </h3>
      ...
      <StatsGrid columns={5} gap="md">
        ...
        <StatsCard label="genres" value="rock" subtitle="hard rock, blues rock" />
      </StatsGrid>
    </div>
  ),
};
...
export const GenreDetail: Story = {
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)] rounded-lg">
      <h3 class="text-[var(--color-text-primary)] text-2xl font-bold mb-4">progressive rock</h3>
...
export const PlaylistStats: Story = {
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)] rounded-lg">
      <h3 class="text-[var(--color-text-primary)] text-2xl font-bold mb-4">my favorite songs</h3>

      <StatsGrid columns={3} gap="md">
        <StatsCard label="songs" value="87" icon="music" />
        <StatsCard label="duration" value="5h 23m" icon="recent" />
        <StatsCard label="last updated" value="2 days ago" icon="recent" variant="default" />
      </StatsGrid>
    </div>
  ),
};
  ...
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)]">
      <StatsGrid columns={4} gap="sm">
        ...
        <StatsCard label="duration" value="3h 12m" icon="recent" variant="compact" />
...
export const WithSubtitles: Story = {
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)]">
      <StatsGrid columns={3} gap="md">
        <StatsCard label="songs" value="1,247" icon="music" subtitle="in library" />
        <StatsCard label="duration" value="87h 32m" icon="recent" subtitle="total playtime" />
        <StatsCard label="rating" value="4.6" icon="star" subtitle="average score" />
      </StatsGrid>
    </div>
  ),
};
...
export const MobileLayout: Story = {
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)] max-w-sm">
      <h3 class="text-[var(--color-text-primary)] text-xl font-bold mb-4">queen</h3>
  ...
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)]">
      <StatsGrid columns={2} gap="lg">
        <StatsCard label="total songs" value="12,847" icon="music" subtitle="across all genres" />
        <StatsCard label="total duration" value="892h 15m" icon="recent" subtitle="of music" />
        <StatsCard label="total artists" value="1,543" icon="artist" subtitle="in collection" />
        <StatsCard label="total albums" value="2,194" icon="album" subtitle="in library" />
      </StatsGrid>
    </div>
  ),
};
...
export const MixedVariants: Story = {
  render: () => (
    <div class="p-6 bg-[var(--color-bg-primary)] space-y-6">
      <div>
        <h4 class="text-[var(--color-text-primary)] text-sm font-semibold mb-2">default variant</h4>
        <StatsGrid columns={3} gap="md">
      ...
      <div>
        <h4 class="text-[var(--color-text-primary)] text-sm font-semibold mb-2">compact variant</h4>
      ...
      <div>
        <h4 class="text-[var(--color-text-primary)] text-sm font-semibold mb-2">minimal variant</h4>
        <StatsGrid columns={3} gap="sm">
