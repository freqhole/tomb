  ...
  return (
    <div
      class="fixed z-[1500] bg-black overflow-hidden group
             inset-x-0 wide:inset-x-auto wide:right-3
             wide:w-72 lg:w-80 xl:w-96 aspect-video"
      style={{
        bottom: "var(--player-bar-height, 0px)",
        "box-shadow": "0 20px 60px -15px rgba(0, 0, 0, 0.8), 0 0 32px 6px rgba(255, 26, 158, 0.55)",
    ...
    >
      ...
      <button
        type="button"
        class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity bg-black/50 rounded p-1.5"
