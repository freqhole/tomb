...
export function StatsGrid(props: StatsGridProps) {
  ...
  const gridClasses = () => {
    const colClasses = {
      1: "grid-cols-1",
      2: "grid-cols-1 wide:grid-cols-2",
      3: "grid-cols-1 wide:grid-cols-2 lg:grid-cols-3",
      4: "grid-cols-2 wide:grid-cols-3 lg:grid-cols-4",
      5: "grid-cols-2 wide:grid-cols-3 lg:grid-cols-5",
      6: "grid-cols-2 wide:grid-cols-4 lg:grid-cols-6",
    };
