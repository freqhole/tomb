...
// step.
//
// digits only (not the original hex alphabet) so it can be typed on a phone's
// numeric keypad (see spume's PairPlayerModal, which uses inputmode="numeric")
// and read easily at couch distance - no ambiguous letter glyphs.
