...
// v19 -> v20: `by_sha256` dropped its `unique` constraint (see
// db/init.ts's migration comment + /memories/repo/tomb-sha256-vs-blake3-vs-id.md) -
// part of the ongoing sha256->blake3 deprecation chip-away, NOT a full
// migration. do not bump this again for the same reason without reading
// that migration's doc comment first.
export const MUSIC_DB_VERSION = 21;
