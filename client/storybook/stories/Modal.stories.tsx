      ...
      <div class="p-8 bg-[var(--color-bg-primary)]">
        ...
        >
          <form onSubmit={handleSubmit} class="space-y-4">
            <div>
              <label class="label text-[var(--color-text-secondary)] mb-2 block">
                name
              </label>
              <input
                type="text"
    ...
    return (
      <div class="p-8 bg-[var(--color-bg-primary)]">
        ...
        >
          <div class="space-y-4">
            <BodyText size="base" class="text-[var(--color-text-secondary)]">
              clicking outside this modal will not close it. you must use the
    ...
    return (
      <div class="p-8 bg-[var(--color-bg-primary)]">
        ...
        >
          <div class="space-y-4">
            <BodyText size="base" class="text-[var(--color-text-secondary)]">
              this is the first modal. you can open another modal on top of this
              one.
            </BodyText>
            <button
              type="button"
