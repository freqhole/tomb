...
describe("SyncEventEmitter", () => {
  ...
  describe("event listener management", () => {
    it("should add and call event listeners", () => {
      ...
      emitter.on(SyncEventType.Started, listener);
    ...
    it("should support multiple listeners for same event type", () => {
      ...
      emitter.on(SyncEventType.Started, listener1);
      emitter.on(SyncEventType.Started, listener2);
    ...
    it("should remove event listeners", () => {
      ...
      emitter.on(SyncEventType.Started, listener);
      emitter.off(SyncEventType.Started, listener);
    ...
    it("should support one-time listeners", () => {
      ...
      emitter.once(SyncEventType.Started, listener);
  ...
  describe("event history", () => {
    ...
    it("should get recent events by type", () => {
      ...
      const progressEvents = emitter.getRecentEvents(
      ...
      const startedEvents = emitter.getRecentEvents(SyncEventType.Started, 10);
  ...
  describe("listener management", () => {
    it("should count listeners by type", () => {
      ...
      expect(emitter.listenerCount(SyncEventType.Started)).toBe(0);

      emitter.on(SyncEventType.Started, listener1);
      expect(emitter.listenerCount(SyncEventType.Started)).toBe(1);

      emitter.on(SyncEventType.Started, listener2);
      expect(emitter.listenerCount(SyncEventType.Started)).toBe(2);

      emitter.off(SyncEventType.Started, listener1);
      expect(emitter.listenerCount(SyncEventType.Started)).toBe(1);
    });
    ...
    it("should count total listeners", () => {
      ...
      emitter.on(SyncEventType.Started, listener1);
      emitter.on(SyncEventType.Progress, listener2);
      emitter.onAny(globalListener);
  ...
  describe("error handling", () => {
    it("should handle listener errors gracefully", () => {
      ...
      emitter.on(SyncEventType.Started, errorListener);
      emitter.on(SyncEventType.Started, workingListener);
...
describe("SyncEventBuilder", () => {
  ...
  describe("event creation", () => {
    it("should create sync started event", () => {
      ...
      expect(event.type).toBe(SyncEventType.Started);
      expect(event.sessionId).toBe(sessionId);
      expect(event.clientId).toBe(clientId);
      expect(event.fullSync).toBe(true);
    ...
    it("should create sync progress event", () => {
      ...
      expect(event.type).toBe(SyncEventType.Progress);
    ...
    it("should create sync completed event", () => {
      ...
      expect(event.type).toBe(SyncEventType.Completed);
    ...
    it("should create sync failed event", () => {
      ...
      const event = builder.syncFailed(error, true);

      expect(event.type).toBe(SyncEventType.Failed);
    ...
    it("should create sync paused event", () => {
      ...
      expect(event.type).toBe(SyncEventType.Paused);
    ...
    it("should create sync resumed event", () => {
      ...
      expect(event.type).toBe(SyncEventType.Resumed);
      expect(event.resumeCursor).toBe("cursor123");
    });
    ...
    it("should create sync conflict event", () => {
      ...
      expect(event.type).toBe(SyncEventType.ConflictDetected);
    ...
    it("should create sync conflict resolved event", () => {
      ...
      expect(event.type).toBe(SyncEventType.ConflictResolved);
    ...
    it("should create items processed event", () => {
      ...
      expect(event.skippedCount).toBe(10);
    });
  });
...
describe("createSyncEventSystem", () => {
  ...
  it("should provide convenience methods that work", () => {
    ...
    system.on(SyncEventType.Started, listener);
  ...
  it("should bind methods correctly", () => {
    ...
    on(SyncEventType.Started, listener);
