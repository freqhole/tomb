    ...
    <div class="p-4">
      <div class="flex items-center justify-between mb-2">
        ...
        <button
          ...
          class="text-xs text-gray-500 hover:text-magenta-400 transition-colors duration-200"
        >
          view all
        </button>
      </div>
      ...
      <button
        ...
        class="w-full mt-2 p-2 bg-gray-800 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-magenta-500/20 transition-all duration-200"
      >
        + create playlist
      </button>
    </div>
