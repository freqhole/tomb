...
export const routes = {
  ...
  music: {
    ...
    delete_song: { method: 'DELETE', path: '/api/songs/{id}', req: null, resp: s.DeleteSongResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    get_genre: { method: 'GET', path: '/api/genres/{id}', req: s.GetGenreRequestSchema, resp: s.GenreQueryResultSchema, auth: { type: 'authenticated' } as const },
    ...
    get_playlist_by_id: { method: 'GET', path: '/api/music/playlists/{id}', req: null, resp: s.PlaylistSchema, auth: { type: 'authenticated' } as const },
    get_playlist_etag: { method: 'HEAD', path: '/api/music/playlists/{id}/etag', req: null, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    get_playlist_images: { method: 'GET', path: '/api/playlists/{id}/images', req: s.GetPlaylistRequestSchema, resp: z.string().array(), auth: { type: 'authenticated' } as const },
