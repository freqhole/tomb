...
export const routes = {
  ...
  admin: {
    ...
    accept_knock: { method: 'POST', path: '/api/admin/knocks/{id}/accept', req: s.ProcessKnockRequestSchema, resp: s.KnockRequestSchema, auth: { type: 'role', role: 'admin' } as const },
    reject_knock: { method: 'POST', path: '/api/admin/knocks/{id}/reject', req: null, resp: s.KnockRequestSchema, auth: { type: 'role', role: 'admin' } as const },
    delete_knock: { method: 'DELETE', path: '/api/admin/knocks/{id}', req: null, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    get_knock: { method: 'GET', path: '/api/admin/knocks/{id}', req: null, resp: s.KnockRequestSchema, auth: { type: 'role', role: 'admin' } as const },
  },
  app: {
