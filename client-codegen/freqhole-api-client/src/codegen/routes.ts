...
export const routes = {
  ...
  music: {
    ...
    create_playback_session: { method: 'POST', path: '/api/analytics/sessions', req: s.CreatePlaybackSessionRequestSchema, resp: s.PlaybackSessionSchema, auth: { type: 'role', role: 'member' } as const },
    ...
    record_video_play: { method: 'POST', path: '/api/analytics/video-play', req: s.RecordVideoPlayRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'member' } as const },
