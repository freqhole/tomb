...
export const routes = {
  admin: {
    ...
    device_linked_callback: { method: 'POST', path: '/api/internal/device-linked', req: s.DeviceLinkedCallbackRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'public' } as const },
    ...
    knock_accepted_callback: { method: 'POST', path: '/api/internal/knock-accepted', req: s.KnockAcceptedCallbackRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'public' } as const },
  ...
  entities: {
    add_entities_tags: { method: 'POST', path: '/api/entities/tags/add', req: s.AddEntitiesTagsRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    add_entity_taxon: { method: 'POST', path: '/api/entities/taxons/add', req: s.AddEntityTaxonRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    add_entity_url: { method: 'POST', path: '/api/entities/urls/add', req: s.AddEntityUrlRequestSchema, resp: s.EntityUrlSchema, auth: { type: 'role', role: 'admin' } as const },
    add_playlist_item: { method: 'POST', path: '/api/entities/playlists/items/add', req: s.AddPlaylistItemRequestSchema, resp: s.PlaylistItemSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    add_playlist_items: { method: 'POST', path: '/api/entities/playlists/items/add-bulk', req: s.AddPlaylistItemsRequestSchema, resp: s.PlaylistItemSchema.array(), auth: { type: 'owner_or', role: 'admin' } as const },
    get_entities_tags: { method: 'POST', path: '/api/entities/tags/get', req: s.GetEntitiesTagsRequestSchema, resp: s.EntityTagCountSchema.array(), auth: { type: 'authenticated' } as const },
    get_entity_images: { method: 'POST', path: '/api/entities/images/get', req: s.GetEntityImagesRequestSchema, resp: s.ImageMetadataSchema.array(), auth: { type: 'authenticated' } as const },
    ...
    get_entity_urls: { method: 'POST', path: '/api/entities/urls/get', req: s.GetEntityUrlsRequestSchema, resp: s.EntityUrlSchema.array(), auth: { type: 'authenticated' } as const },
    ...
    list_entity_type_tags: { method: 'POST', path: '/api/entities/tags/list-by-type', req: s.ListEntityTypeTagsRequestSchema, resp: s.EntityTagCountSchema.array(), auth: { type: 'authenticated' } as const },
    ...
    remove_entities_tags: { method: 'POST', path: '/api/entities/tags/remove', req: s.RemoveEntitiesTagsRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    remove_playlist_items: { method: 'POST', path: '/api/entities/playlists/items/remove-bulk', req: s.RemovePlaylistItemsRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'owner_or', role: 'admin' } as const },
  ...
  music: {
    ...
    build_atlas: { method: 'POST', path: '/api/blobs/atlas', req: s.BuildAtlasRequestSchema, resp: s.AtlasManifestSchema, auth: { type: 'authenticated' } as const },
    ...
    cancel_job: { method: 'POST', path: '/api/jobs/cancel', req: s.CancelJobRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    ...
    create_playback_session: { method: 'POST', path: '/api/analytics/sessions', req: s.CreatePlaybackSessionRequestSchema, resp: s.PlaybackSessionSchema, auth: { type: 'authenticated' } as const },
    ...
    create_precheck_fetch_job: { method: 'POST', path: '/api/music/fetch/precheck', req: s.PreCheckFetchParamsSchema, resp: s.JobResponseSchema, auth: { type: 'role', role: 'member' } as const },
    ...
    delete_playback_session: { method: 'POST', path: '/api/analytics/sessions/delete', req: s.DeletePlaybackSessionRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    ...
    delete_taxon: { method: 'POST', path: '/api/taxonomy/taxons/delete', req: s.DeleteTaxonRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    find_by_merged_key: { method: 'POST', path: '/api/music/relations/by-merged-key', req: s.FindByMergedKeyRequestSchema, resp: s.FindByMergedKeyResponseSchema, auth: { type: 'authenticated' } as const },
    ...
    list_pending_import_review: { method: 'POST', path: '/api/music/import/pending', req: s.ListPendingReviewRequestSchema, resp: s.PendingReviewSessionSchema.array(), auth: { type: 'authenticated' } as const },
    list_playback_sessions: { method: 'POST', path: '/api/analytics/sessions/list', req: s.ListPlaybackSessionsRequestSchema, resp: s.ListPlaybackSessionsResponseSchema, auth: { type: 'authenticated' } as const },
    ...
    list_related_artists_batch: { method: 'POST', path: '/api/related-artists/list-batch', req: s.ListRelatedArtistsBatchRequestSchema, resp: s.ListRelatedArtistsBatchResponseSchema, auth: { type: 'authenticated' } as const },
    list_tags: { method: 'GET', path: '/api/tags/list', req: null, resp: s.TagSchema.array(), auth: { type: 'authenticated' } as const },
    list_taxon_kinds: { method: 'POST', path: '/api/taxonomy/kinds/list', req: s.ListTaxonKindsRequestSchema, resp: s.TaxonKindSchema.array(), auth: { type: 'authenticated' } as const },
    list_taxon_parents_for_kind: { method: 'POST', path: '/api/taxonomy/parents/list-by-kind', req: s.ListTaxonParentsForKindRequestSchema, resp: s.TaxonParentEdgeSchema.array(), auth: { type: 'authenticated' } as const },
    ...
    mark_album_reviewed: { method: 'POST', path: '/api/music/import/mark-reviewed', req: s.MarkAlbumReviewedRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    merge_albums_review: { method: 'POST', path: '/api/music/import/merge-albums', req: s.MergeAlbumsReviewRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    move_song_review: { method: 'POST', path: '/api/music/import/move-song', req: s.MoveSongReviewRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    patch_album_review: { method: 'POST', path: '/api/music/import/patch-album', req: s.PatchAlbumReviewRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    ...
    recently_added_albums: { method: 'POST', path: '/api/music/relations/recently-added-albums', req: s.RecentlyAddedAlbumsRequestSchema, resp: s.RecentlyAddedAlbumsResponseSchema, auth: { type: 'authenticated' } as const },
    record_play: { method: 'POST', path: '/api/analytics/play', req: s.RecordPlayRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    ...
    record_video_play: { method: 'POST', path: '/api/analytics/video-play', req: s.RecordVideoPlayRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    ...
    set_taxon_kind_label: { method: 'POST', path: '/api/taxonomy/kinds/set-label', req: s.SetTaxonKindLabelRequestSchema, resp: s.TaxonKindSchema, auth: { type: 'role', role: 'admin' } as const },
    set_taxon_label: { method: 'POST', path: '/api/taxonomy/taxons/set-label', req: s.SetTaxonLabelRequestSchema, resp: s.TaxonSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    unassigned_albums: { method: 'POST', path: '/api/music/relations/unassigned-albums', req: s.UnassignedAlbumsRequestSchema, resp: s.UnassignedAlbumsResponseSchema, auth: { type: 'authenticated' } as const },
    ...
    update_playback_session_items: { method: 'POST', path: '/api/analytics/sessions/items', req: s.UpdatePlaybackSessionItemsRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'owner' } as const },
    update_playback_session_progress: { method: 'POST', path: '/api/analytics/sessions/progress', req: s.UpdatePlaybackSessionProgressRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'owner' } as const },
    update_playback_session_status: { method: 'POST', path: '/api/analytics/sessions/status', req: s.UpdatePlaybackSessionStatusRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'owner' } as const },
  ...
  video: {
    bulk_delete_videos: { method: 'POST', path: '/api/video/videos/bulk-delete', req: s.BulkDeleteVideosRequestSchema, resp: s.BulkDeleteVideosResponseSchema, auth: { type: 'role', role: 'admin' } as const },
    create_video: { method: 'POST', path: '/api/video/videos', req: s.CreateVideoRequestSchema, resp: s.VideoSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    list_videos_by_series: { method: 'POST', path: '/api/video/videos/list-by-series', req: s.ListVideosBySeriesRequestSchema, resp: s.VideoSchema.array(), auth: { type: 'authenticated' } as const },
    list_videos_unattached: { method: 'POST', path: '/api/video/videos/list-unattached', req: s.ListVideosUnattachedRequestSchema, resp: s.VideoSchema.array(), auth: { type: 'authenticated' } as const },
    mark_video_group_reviewed: { method: 'POST', path: '/api/video/import/mark-reviewed', req: s.MarkVideoGroupReviewedRequestSchema, resp: s.VideoImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    move_video_review: { method: 'POST', path: '/api/video/import/move-video', req: s.MoveVideoReviewRequestSchema, resp: s.VideoImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    patch_video_group_review: { method: 'POST', path: '/api/video/import/patch-group', req: s.PatchVideoGroupReviewRequestSchema, resp: s.VideoImportReviewOkSchema, auth: { type: 'owner_or', role: 'admin' } as const },
    ...
    reprocess_video: { method: 'POST', path: '/api/video/videos/reprocess', req: s.ReprocessVideoRequestSchema, resp: s.ReprocessVideoResultSchema, auth: { type: 'role', role: 'admin' } as const },
    ...
    video_pending: { method: 'POST', path: '/api/video/import/video-pending', req: s.VideoPendingRequestSchema, resp: s.VideoPendingResponseSchema, auth: { type: 'authenticated' } as const },
    videos_by_value: { method: 'POST', path: '/api/video/relations/videos-by-value', req: s.VideosByValueRequestSchema, resp: s.VideosByValueResponseSchema, auth: { type: 'authenticated' } as const },
  },
} as const;
