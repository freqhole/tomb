...
export const routes = {
  ...
  music: {
    get_job_status: { method: 'POST', path: '/api/jobs/status', req: s.GetJobRequestSchema, resp: s.JobSchema, auth: { type: 'authenticated' } as const },
    list_jobs: { method: 'POST', path: '/api/jobs/list', req: s.ListJobsRequestSchema, resp: s.JobSchema.array(), auth: { type: 'authenticated' } as const },
    ...
    create_fetch_job: { method: 'POST', path: '/api/music/fetch', req: s.FetchMediaParamsSchema, resp: s.JobSchema, auth: { type: 'role', role: 'member' } as const },
    get_fetch_job: { method: 'GET', path: '/api/music/fetch/{id}', req: s.GetJobRequestSchema, resp: s.JobSchema, auth: { type: 'authenticated' } as const },
