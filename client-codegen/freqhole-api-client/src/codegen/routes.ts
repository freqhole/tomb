...
export const routes = {
  ...
  music: {
    ...
    set_album_review_status: { method: 'POST', path: '/api/albums/set-review-status', req: s.SetAlbumReviewStatusRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'role', role: 'admin' } as const },
