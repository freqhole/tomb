...
export const routes = {
  ...
  gossip: {
    create_gossip_channel: { method: 'POST', path: '/api/gossip/channels', req: s.CreateChannelRequestSchema, resp: s.GossipChannelSchema, auth: { type: 'authenticated' } as const },
    delete_gossip_message: { method: 'POST', path: '/api/gossip/messages/delete', req: s.DeleteMessageRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    get_gossip_channel: { method: 'POST', path: '/api/gossip/channels/get', req: s.GetChannelRequestSchema, resp: s.ChannelDetailResponseSchema, auth: { type: 'authenticated' } as const },
    get_gossip_channel_invite: { method: 'POST', path: '/api/gossip/channels/invite', req: s.GetChannelRequestSchema, resp: s.ChannelInviteSchema, auth: { type: 'authenticated' } as const },
    get_gossip_messages: { method: 'POST', path: '/api/gossip/messages/list', req: s.GetMessagesWithChannelRequestSchema, resp: s.MessagesResponseSchema, auth: { type: 'authenticated' } as const },
    get_gossip_profile: { method: 'POST', path: '/api/gossip/profile', req: s.EmptyRequestSchema, resp: s.GossipProfileSchema, auth: { type: 'authenticated' } as const },
    join_gossip_channel: { method: 'POST', path: '/api/gossip/channels/join', req: s.JoinChannelRequestSchema, resp: s.GossipChannelSchema, auth: { type: 'authenticated' } as const },
    leave_gossip_channel: { method: 'POST', path: '/api/gossip/channels/leave', req: s.GetChannelRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    list_gossip_channels: { method: 'POST', path: '/api/gossip/channels/list', req: s.EmptyRequestSchema, resp: s.GossipChannelSchema.array(), auth: { type: 'authenticated' } as const },
    list_gossip_members: { method: 'POST', path: '/api/gossip/members/list', req: s.GetChannelRequestSchema, resp: s.GossipChannelMemberSchema.array(), auth: { type: 'authenticated' } as const },
    react_gossip_message: { method: 'POST', path: '/api/gossip/messages/react', req: s.ReactWithChannelRequestSchema, resp: s.EmptyResponseSchema, auth: { type: 'authenticated' } as const },
    send_gossip_message: { method: 'POST', path: '/api/gossip/messages/send', req: s.SendMessageWithChannelRequestSchema, resp: s.GossipMessageSchema, auth: { type: 'authenticated' } as const },
    update_gossip_profile: { method: 'POST', path: '/api/gossip/profile/update', req: s.UpdateProfileRequestSchema, resp: s.GossipProfileSchema, auth: { type: 'authenticated' } as const },
  },
  music: {
