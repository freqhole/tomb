...
export const routes = {
  ...
  music: {
    ...
    mark_album_reviewed: { method: 'POST', path: '/api/music/import/mark-reviewed', req: s.MarkAlbumReviewedRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'authenticated' } as const },
    merge_albums_review: { method: 'POST', path: '/api/music/import/merge-albums', req: s.MergeAlbumsReviewRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'authenticated' } as const },
    move_song_review: { method: 'POST', path: '/api/music/import/move-song', req: s.MoveSongReviewRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'authenticated' } as const },
    patch_album_review: { method: 'POST', path: '/api/music/import/patch-album', req: s.PatchAlbumReviewRequestSchema, resp: s.ImportReviewOkSchema, auth: { type: 'authenticated' } as const },
