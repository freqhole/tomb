...
export const adminCommands = {
  ...
  peers_hard_delete: { req: s.AdminPeersHardDeleteRequestSchema, resp: s.AdminPeersHardDeleteResponseSchema, auth: { type: 'admin' } as const },
  peers_list_all: { req: s.AdminPeersListAllRequestSchema, resp: s.AdminPeerSummarySchema.array(), auth: { type: 'admin' } as const },
  ...
  peers_reassign_user: { req: s.AdminPeersReassignUserRequestSchema, resp: z.unknown().optional(), auth: { type: 'admin' } as const },
  peers_remove: { req: s.AdminPeersRemoveRequestSchema, resp: z.unknown().optional(), auth: { type: 'admin' } as const },
  peers_restore: { req: s.AdminPeersRestoreRequestSchema, resp: z.unknown().optional(), auth: { type: 'admin' } as const },
  ...
  users_add_peer_node: { req: s.AdminUsersAddPeerNodeRequestSchema, resp: s.AdminPeerNodeSummarySchema, auth: { type: 'admin' } as const },
  ...
  users_hard_delete: { req: s.AdminUsersHardDeleteRequestSchema, resp: z.unknown().optional(), auth: { type: 'admin' } as const },
  users_list: { req: s.AdminUsersListRequestSchema, resp: s.AdminUserSummarySchema.array(), auth: { type: 'admin' } as const },
  users_remove_peer_node: { req: s.AdminUsersRemovePeerNodeRequestSchema, resp: z.unknown().optional(), auth: { type: 'admin' } as const },
  users_restore: { req: s.AdminUsersRestoreRequestSchema, resp: s.AdminUserSummarySchema, auth: { type: 'admin' } as const },
