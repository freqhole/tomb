...
export class MiddenNode {
    ...
    download_verified_to_store(peer_addr, blake3_hash) {
        ...
        const ptr1 = passStringToWasm0(blake3_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.middennode_download_verified_to_store(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    download_verified_to_store_with_ensure(peer_addr, blake3_hash) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ptr0 = passStringToWasm0(peer_addr, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(blake3_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.middennode_download_verified_to_store_with_ensure(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
...
export class MiddenNodeOptions {
     ...
     * @returns {boolean}
     */
    get relay_custom_only() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.middennodeoptions_get_relay_custom_only(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    get relay_urls() {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.middennodeoptions_get_relay_urls(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    ...
    /**
     * @param {boolean} custom_only
     */
    set relay_custom_only(custom_only) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        _assertBoolean(custom_only);
        wasm.middennodeoptions_set_relay_custom_only(this.__wbg_ptr, custom_only);
    }
    /**
    ...
    set relay_urls(urls) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        var ptr0 = isLikeNone(urls) ? 0 : passArrayJsValueToWasm0(urls, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.middennodeoptions_set_relay_urls(this.__wbg_ptr, ptr0, len0);
    }
    /**
...
export function __wbindgen_cast_0000000000000001() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 2960, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
export function __wbindgen_cast_0000000000000002() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 5078, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
...
export function __wbindgen_cast_0000000000000003() { return logError(function (arg0, arg1) {
    ...
    const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hf9ac4cdba271a712);
    return ret;
}, arguments); }
export function __wbindgen_cast_0000000000000004() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 3442, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
export function __wbindgen_cast_0000000000000005() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 2924, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
export function __wbindgen_cast_0000000000000006() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 3135, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
export function __wbindgen_cast_0000000000000007() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 3186, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
    const ret = makeClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h6fa831d487cd613c);
    return ret;
}, arguments); }
export function __wbindgen_cast_0000000000000008() { return logError(function (arg0, arg1) {
    // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 5047, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
    const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hdf2ea485b4f2a079);
    return ret;
}, arguments); }
...
function wasm_bindgen__convert__closures_____invoke__h6fa831d487cd613c(arg0, arg1) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.wasm_bindgen__convert__closures_____invoke__h6fa831d487cd613c(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__hdf2ea485b4f2a079(arg0, arg1) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.wasm_bindgen__convert__closures_____invoke__hdf2ea485b4f2a079(arg0, arg1);
}
...
function wasm_bindgen__convert__closures_____invoke__hf9ac4cdba271a712(arg0, arg1, arg2) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.wasm_bindgen__convert__closures_____invoke__hf9ac4cdba271a712(arg0, arg1, arg2);
}
