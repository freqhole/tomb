...
export const middennode_get_active_transfers: (a: number) => [number, number, number];
...
export const middennodeoptions_get_relay_custom_only: (a: number) => number;
export const middennodeoptions_get_relay_urls: (a: number) => [number, number];
...
export const middennodeoptions_set_relay_custom_only: (a: number, b: number) => void;
export const middennodeoptions_set_relay_urls: (a: number, b: number, c: number) => void;
