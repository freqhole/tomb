import{r as S,i as y,c as u,h as w,t as c,k as n,b as f,e as P,s as b}from"./web-Bmt1sUg0.js";import{G as _}from"./generic-infinite-grid-COEw9occ.js";var G=c('<code style="font-size:12px;background:#333;padding:2px 4px;border-radius:3px;">'),M=c("<span style=color:#10b981;font-weight:600;>$"),k=c("<span>"),C=c("<span><span style=margin-left:4px;font-size:12px;color:#888;>"),v=c(`<div class=product-data-grid-demo><style>
