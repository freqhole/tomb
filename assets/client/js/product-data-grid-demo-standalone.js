import{r as S,f as y,e as u,g as w,t as c,i as n,c as f,b as P,s as b}from"./web-BLoVs608.js";import{G as _}from"./generic-infinite-grid-Dg1UN-n7.js";var G=c('<code style="font-size:12px;background:#333;padding:2px 4px;border-radius:3px;">'),M=c("<span style=color:#10b981;font-weight:600;>$"),k=c("<span>"),C=c("<span><span style=margin-left:4px;font-size:12px;color:#888;>"),v=c(`<div class=product-data-grid-demo><style>
