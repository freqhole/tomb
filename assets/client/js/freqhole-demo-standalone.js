import{d as ne,c as M,t as S,a as Oe,b as P,e as ce,s as F,o as ue,f as fe,g as pe,h as V,i as z,j as ct,u as ut,k as u,m as G,F as ge,S as O,l as te,n as he,r as ft}from"./web-Bmt1sUg0.js";import{u as Le}from"./thumbnail-utils-D6fSeTdM.js";import{u as gt}from"./useThumbnail-DFBzkTrD.js";import"./websocket-client-BIZ3xMI1.js";import"./types-DDODKsJP.js";function X(e){if(e.metadata&&typeof e.metadata=="object"){const t=e.metadata;if(t.originalName||t.filename||t.original_filename||t.file_name||t.name)return t.originalName||t.filename||t.original_filename||t.file_name||t.name}return e.local_path?.split("/").pop()||`${e.sha256?.slice(0,8)||e.id.slice(0,8)}...${e.sha256?.slice(-4)||e.id.slice(-4)}`}var pt=S(`<div title="Drag to resize • Drag far to close panel"><div class=resize-handle-indicator></div><div class=resize-handle-hint>Drag to resize • Drag far to close</div><style>
      ...
      `;return y!==d.e&&ce(k,d.e=y),d.t=F(k,$,d.t),d},{e:void 0,t:void 0}),k})()}ne(["click","input"]);var Nt=S(`<div class="edge-toggle-button edge-toggle-left"title="Show Browse panel"style="position:fixed;top:50%;left:0;transform:translateY(-50%);width:24px;height:80px;background:#2a2a2a;border:1px solid #3a3a3a;border-radius:0 8px 8px 0;cursor:pointer;z-index:1000;display:flex;flex-direction:column;align-items:center;justify-content:center;transition:all 0.2s ease;color:#888;font-size:12px;font-weight:500;user-select:none;box-shadow:0 2px 8px rgba(0, 0, 0, 0.3);overflow:hidden;"><div class=arrow-container>→</div><div class=panel-name style=writing-mode:vertical-rl;text-orientation:mixed;font-size:10px;text-transform:uppercase;letter-spacing:1px;line-height:1.2;>Browse</div><style>
        ...
        `);function qt(){const{selection:e,state:t,addLog:n}=me(),o=()=>{const a=e.selectedItems().size;n(`📥 Downloading ${a} selected items`)},c=a=>{if(t.bulkActionMenu()?.isOpen)t.setBulkActionMenu(null);else{const g=a.target.getBoundingClientRect(),h={x:g.left+g.width/2-100,y:g.top-10};t.setBulkActionMenu({isOpen:!0,position:h});const f=e.selectedItems().size;n(`⋯ Bulk action menu opened for ${f} items`)}},s=()=>{const a=e.selectedItems().size;e.clearSelection(),n(`🗑️ Cleared selection of ${a} items`)},p=()=>e.selectedItems().size;return z(O,{get when(){return p()>1},get children(){var a=Vt(),l=a.firstChild,g=l.firstChild,h=g.nextSibling;h.nextSibling;var f=l.nextSibling,m=f.nextSibling,i=m.nextSibling;return u(l,p,g),u(l,()=>p()===1?"":"s",h),f.$$click=o,m.$$click=c,i.$$click=s,a}})}ne(["click"]);const Y={colors:{background:"#000000",text:"#ffffff",border:"#3a3a3a",header:"#1a1a1a",hover:"#2a2a2a",selected:"#ff00ff"}},Kt=(e,t,n)=>{if(e==null&&t==null)return 0;if(e==null)return 1;if(t==null)return-1;const o=e[n],c=t[n];if(o==null&&c==null)return 0;if(o==null)return 1;if(c==null)return-1;if(n==="name"){const g=X(e),h=X(t);return g.localeCompare(h,void 0,{numeric:!0,sensitivity:"base"})}if(n.includes("_at")||n.includes("date")||n.includes("time")){const g=new Date(o),h=new Date(c);if(!isNaN(g.getTime())&&!isNaN(h.getTime()))return g.getTime()-h.getTime()}const s=Number(o),p=Number(c);if(!isNaN(s)&&!isNaN(p)&&typeof o=="number"&&typeof c=="number")return s-p;if(n==="size"&&typeof o=="string"&&typeof c=="string"){const g=Ke(o),h=Ke(c);if(g!==null&&h!==null)return g-h}const a=String(o).toLowerCase(),l=String(c).toLowerCase();return n==="name"||n.includes("filename")?a.localeCompare(l,void 0,{numeric:!0,sensitivity:"base"}):a.localeCompare(l)},Ke=e=>{const t=e.match(/^([\d.]+)\s*(B|KB|MB|GB|TB)?$/i);if(!t||!t[1])return null;const n=parseFloat(t[1]),o=(t[2]||"B").toUpperCase(),c={B:1,KB:1024,MB:1024*1024,GB:1024*1024*1024,TB:1024*1024*1024*1024};return n*(c[o]||1)};function Yt(e){const t=e.defaultSort||{field:"created_at",direction:"desc"},[n,o]=M(e.initialSort||t),[c,s]=M(new Set),[p,a]=M(!1),[l,g]=M(!1),h=e.getItemId||(r=>r.id||String(r)),f=V(()=>{const r=n(),v=[...e.data];return v.length>1e3&&(g(!0),setTimeout(()=>g(!1),100)),v.sort((x,d)=>{const y=Kt(x,d,r.field);return r.direction==="desc"?y*-1:y})});return{sortConfig:n,selectedItems:c,isDragSelecting:p,isSorting:l,sortedData:f,handleSort:r=>{const v=n();if(v.field===r){const x=r.includes("_at")||r.includes("date")||r.includes("time")?"desc":"asc",d=x==="desc"?"asc":"desc";v.direction===x?o({field:r,direction:d}):v.direction===d?o(t):o({field:r,direction:x})}else{const x=r.includes("_at")||r.includes("date")||r.includes("time")?"desc":"asc";o({field:r,direction:x})}},toggleSelection:r=>{const v=new Set(c());v.has(r)?v.delete(r):v.add(r),s(v)},clearSelection:()=>{s(new Set)},selectAll:()=>{const r=new Set(e.data.map(h));s(r)},isSelected:r=>c().has(r),selectRange:(r,v)=>{const x=new Set(c()),d=Math.min(r,v),y=Math.max(r,v);for(let $=d;$<=y;$++)if($<e.data.length&&e.data[$]!=null){const U=h(e.data[$]);x.add(U)}s(x)},setIsDragSelecting:a,getItemId:h}}var et=S("<div>"),jt=S("<div class=grid-cell>"),Ye=S("<div class=grid-content>"),Xt=S("<span style=margin-left:8px;color:#ff00ff;>Loading..."),Gt=S("<div class=grid-stats>Showing rows <!>-<!> of "),Qt=S("<div><div class=grid-body style=flex:1;overflow-y:auto;overflow-x:auto;position:relative;><div class=grid-header></div></div><style>"),Jt=S('<div style="position:absolute;right:40px;top:50%;transform:translateY(-50%);color:#00ff88;font-size:12px;animation:spin 1s linear infinite;">⟳'),Zt=S('<div class=sort-indicator><div class="sort-arrow sort-arrow-up"></div><div class="sort-arrow sort-arrow-down">'),en=S("<div><div style=font-weight:500;flex:1;>"),tn=S("<span>");function je(e){let t;ue(()=>{e.onRowMount&&e.onRowMount(e.item)});const n=()=>e.focusedIndex===e.index&&e.showFocusIndicator;return(()=>{var o=et();o.$$contextmenu=s=>e.onContextMenu?.(e.item,e.index,s),o.$$mousedown=s=>e.onRowMouseDown?.(e.item,e.index,s),o.$$dblclick=s=>e.onRowDoubleClick?.(e.item,e.index,s),o.$$click=s=>e.onRowClick?.(e.item,e.index,s);var c=t;return typeof c=="function"?he(c,o):t=o,u(o,z(ge,{get each(){return e.columns},children:s=>(()=>{var p=jt();return u(p,(()=>{var a=G(()=>!!s.render);return()=>a()?s.render(e.item,e.index):String(e.item[s.key]||"")})()),P(a=>F(p,`
        ...
        outline-offset: -2px;
        position: relative;
      `;return p!==s.e&&ce(o,s.e=p),s.t=F(o,a,s.t),s},{e:void 0,t:void 0}),o})()}function nn(e){const[t,n]=M(),[o,c]=M(0),[s,p]=M(0),a=e.rowHeight||50,l=e.headerHeight||60,g=e.virtualizeThreshold||100,[h,f]=M(!1),[m,i]=M(null),[,b]=M(null),w=V(()=>e.columns.reduce((I,E)=>I+(E.width||200),0)),k=Yt({data:e.data,getItemId:e.getItemId,initialSort:e.sortField?{field:e.sortField,direction:e.sortDirection||"asc"}:void 0,defaultSort:e.defaultSort}),D=(I,E,T)=>{e.onRowClick?.(I,E,T)},r=(I,E,T)=>{h()&&(f(!1),i(null),b(null)),e.onRowDoubleClick?.(I,E,T)},v=(I,E,T)=>{T.button===0&&!T.metaKey&&!T.ctrlKey&&!T.shiftKey&&(T.preventDefault(),i({x:T.clientX,y:T.clientY,startIndex:E})),e.onRowMouseDown?.(I,E,T)},x=V(()=>e.data.length>g),d=V(()=>{if(!x())return e.data.map((A,H)=>({item:A,index:H}));if(!t())return[];const E=a,T=o(),B=s(),C=Math.floor(T/E),L=Math.min(e.data.length-1,Math.ceil((T+B)/E)+5),W=[];for(let A=Math.max(0,C-5);A<=L;A++)A<e.data.length&&e.data[A]!=null&&W.push({item:e.data[A],index:A});return W}),y=V(()=>e.data.length===0?0:t()?Math.floor(o()/a)+1:1),$=V(()=>{if(e.data.length===0)return 0;if(!t())return Math.min(1,e.data.length);const E=s()-l,T=Math.floor(E/a),B=Math.floor(o()/a)+T;return Math.min(B,e.data.length)}),U=V(()=>e.data.length),q=V(()=>e.data.length*a),oe=(I,E)=>{const T=t();if(!T)return-1;const B=T.getBoundingClientRect(),L=E-B.top+T.scrollTop-l;if(L<0)return-1;const W=Math.floor(L/a);return Math.max(0,Math.min(e.data.length-1,W))},J=I=>{const E=document.body.style.overflow==="hidden",T=document.body.classList.contains("modal-open");if(E||T){(h()||m())&&(f(!1),i(null),b(null));return}const B=m();if(B&&!h()&&Math.sqrt(Math.pow(I.clientX-B.x,2)+Math.pow(I.clientY-B.y,2))>5&&f(!0),h()&&B){const C=oe(I.clientX,I.clientY);if(b({x:I.clientX,y:I.clientY,endIndex:C}),C>=0&&e.getItemId&&e.onDragSelection){const L=Math.min(B.startIndex,C),W=Math.max(B.startIndex,C),A=e.data.slice(L,W+1),H=new Set(A.map(K=>e.getItemId(K)));e.onDragSelection(H)}}},Q=()=>{h()?(f(!1),i(null),b(null)):i(null)},ie=I=>{const E=I.target;if(c(E.scrollTop),e.onLoadMore&&e.hasMore&&!e.isLoadingMore){const T=E.scrollHeight,B=E.scrollTop,C=E.clientHeight;T-B-C<200&&e.onLoadMore()}},ae=I=>{if(k.handleSort(I),e.onSort){const E=k.sortConfig();e.onSort(E.field,E.direction)}};return ue(()=>{document.addEventListener("mousemove",J),document.addEventListener("mouseup",Q),fe(()=>{document.removeEventListener("mousemove",J),document.removeEventListener("mouseup",Q)})}),ue(()=>{const I=t();if(!I)return;const E=new ResizeObserver(T=>{for(const B of T)p(B.contentRect.height)});E.observe(I),fe(()=>{E.disconnect()})}),(()=>{var I=Qt(),E=I.firstChild,T=E.firstChild,B=E.nextSibling;return E.addEventListener("scroll",ie),he(n,E),u(T,z(ge,{get each(){return e.columns},children:C=>(()=>{var L=en(),W=L.firstChild;return L.$$click=()=>C.sortable&&!k.isSorting()&&ae(C.key),u(W,(()=>{var A=G(()=>typeof C.title=="string");return()=>A()?(()=>{var H=tn();return u(H,()=>C.title),H})():C.title})()),u(L,z(O,{get when(){return G(()=>!!k.isSorting())()&&k.sortConfig().field===C.key},get children(){return Jt()}}),null),u(L,z(O,{get when(){return C.sortable},get children(){var A=Zt(),H=A.firstChild,K=H.nextSibling;return P(Z=>{var re=`
                      display: flex;
                      flex-direction: column;
                      align-items: center;
                      gap: 1px;
      ...
      `),P(C=>{var L=`infinite-data-grid ${e.className||""} ${h()?"drag-selecting":""}`,W=`
        height: 100%;
        display: flex;
        flex-direction: column;
        background: ${Y.colors.background};
      ...
      `,A=`
            ...
            z-index: 10;
            min-width: ${w()}px;
          `;return L!==C.e&&ce(I,C.e=L),C.t=F(I,W,C.t),C.a=F(T,A,C.a),C},{e:void 0,t:void 0,a:void 0}),I})()}ne(["click","dblclick","mousedown","contextmenu"]);const on={compact:{rowHeight:32,showThumbnails:!1,maxColumns:4,fontSize:"11px",padding:"4px 8px",thumbnailSize:24},default:{rowHeight:50,showThumbnails:!0,maxColumns:8,fontSize:"13px",padding:"8px 12px",thumbnailSize:32},detailed:{rowHeight:70,showThumbnails:!0,maxColumns:12,fontSize:"14px",padding:"12px 16px",thumbnailSize:50}};function rn(e="default"){const[t,n]=M(e),o=()=>on[t()];return{viewMode:t,setViewMode:n,cycleViewMode:()=>{const p=["compact","default","detailed"],l=(p.indexOf(t())+1)%p.length,g=p[l];g&&n(g)},getViewModeConfig:o,getRowHeight:()=>o().rowHeight}}function ln(e){const[t,n]=M(-1),o=i=>{e.onLog&&e.onLog(i)},c=()=>{if(e.isTextInputFocused)return e.isTextInputFocused();const i=document.activeElement;return i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.isContentEditable||i.getAttribute("contenteditable")==="true")},s=()=>e.getAllItems?e.getAllItems():[],p=()=>e.getSelectedItems?e.getSelectedItems():new Set,a=()=>{const i=s(),b=t();return b>=0&&b<i.length&&i[b]||null},l=()=>{const i=s();if(i.length===0)return;const b=t(),w=b<i.length-1?b+1:0;n(w),o(`⌨️ Focused next item: ${w+1}/${i.length}`)},g=()=>{const i=s();if(i.length===0)return;const b=t(),w=b>0?b-1:i.length-1;n(w),o(`⌨️ Focused previous item: ${w+1}/${i.length}`)},h=()=>{s().length!==0&&(n(0),o("⌨️ Focused first item"))},f=()=>{const i=s();i.length!==0&&(n(i.length-1),o("⌨️ Focused last item"))},m=i=>{if(c())return;const b=s();if(b.length!==0)switch(i.key){case"ArrowDown":{i.preventDefault(),t()===-1?h():l();break}case"ArrowUp":{i.preventDefault(),t()===-1?f():g();break}case"Home":{(i.ctrlKey||i.metaKey)&&(i.preventDefault(),h());break}case"End":{(i.ctrlKey||i.metaKey)&&(i.preventDefault(),f());break}case"PageDown":{i.preventDefault();const w=t(),k=Math.min(w+10,b.length-1);n(k),o(`⌨️ Page down to item: ${k+1}/${b.length}`);break}case"PageUp":{i.preventDefault();const w=t(),k=Math.max(w-10,0);n(k),o(`⌨️ Page up to item: ${k+1}/${b.length}`);break}case"Enter":{i.preventDefault();const w=a();w&&e.onPreview&&(e.onPreview(w),o("⌨️ Opened preview via Enter key"));break}case" ":case"Spacebar":{i.preventDefault();const w=a();w&&e.onToggleSelection&&(e.onToggleSelection(w),o("⌨️ Toggled selection via Space key"));break}case"a":{(i.ctrlKey||i.metaKey)&&(i.preventDefault(),e.onSelectAll&&(e.onSelectAll(b),o("⌨️ Selected all items via Ctrl+A")));break}case"Escape":{i.preventDefault(),e.onEscape&&e.onEscape(),n(-1),o("⌨️ Cleared focus via Escape");break}case"Delete":case"Backspace":{const w=p();if(w.size>0){i.preventDefault();const D=s().filter(r=>w.has(r.id));e.onDelete&&(e.onDelete(D),o(`⌨️ Delete requested via ${i.key} key`))}break}case"Tab":{t()===-1&&b.length>0&&n(0);break}case"j":{!i.ctrlKey&&!i.metaKey&&!i.altKey&&(i.preventDefault(),t()===-1?h():l());break}case"k":{!i.ctrlKey&&!i.metaKey&&!i.altKey&&(i.preventDefault(),t()===-1?f():g());break}case"g":{i.shiftKey?(i.preventDefault(),f()):(i.preventDefault(),h());break}}};return pe(()=>{s().length>0&&t()}),pe(()=>{const i=s();t()>=i.length&&i.length>0?n(i.length-1):i.length===0&&n(-1)}),{focusedIndex:t,setFocusedIndex:n,handleKeyDown:m,focusNext:l,focusPrevious:g,focusFirst:h,focusLast:f,getFocusedItem:a}}var sn=S(`<div><style>
        @keyframes pulse {
          0%, 100% {
            opacity: 1;
          }
      ...
      `,g=`${e.item.mime||"unknown"} - ${e.item.id.slice(0,8)}`;return a!==p.e&&ce(c,p.e=a),p.t=F(c,l,p.t),g!==p.a&&te(c,"title",p.a=g),p},{e:void 0,t:void 0,a:void 0}),c})()}function nt(e){if(e===0)return"0 B";const t=1024,n=["B","KB","MB","GB","TB","PB"],o=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,o)).toFixed(2))+" "+n[o]}function fn(e){const t=new Date,n=typeof e=="string"?new Date(e):e;if(isNaN(n.getTime()))return"Invalid date";const o=t.getTime()-n.getTime(),c=Math.floor(o/1e3),s=Math.floor(c/60),p=Math.floor(s/60),a=Math.floor(p/24),l=Math.floor(a/7),g=Math.floor(a/30);if(Math.floor(a/365)>=1)return n.getFullYear().toString();const f=new Intl.RelativeTimeFormat("en",{numeric:"auto",style:"long"});return c<60?c<10?"a moment ago":f.format(-c,"second"):s<60?f.format(-s,"minute"):p<24?f.format(-p,"hour"):a<7?f.format(-a,"day"):l<4?f.format(-l,"week"):g<12?f.format(-g,"month"):n.getFullYear().toString()}function gn(e){const t=typeof e=="string"?new Date(e):e;return isNaN(t.getTime())?"Invalid date":new Intl.DateTimeFormat("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"2-digit",second:"2-digit",timeZoneName:"short"}).format(t)}function Xe(e){return{relative:fn(e),full:gn(e)}}var pn=S("<span style=font-weight:500;>"),$e=S("<span>"),hn=S("<span style=font-family:monospace;font-size:12px;>"),mn=S("<span>—"),bn=S("<button title=Controls>⋯"),xn=S('<button style="background:transparent;border:1px solid #666;color:#888;padding:4px 8px;border-radius:4px;cursor:pointer;font-size:12px;transition:all 0.2s;"title="More actions">⋯');function yn(e){const{state:t,selection:n,addLog:o}=me(),c=t.loadState(),s=rn(c.viewMode||"default"),p=Ze({baseColumnVisibility:()=>t.columnVisibility()}),a=Le({wsUrl:t.wsUrl(),channels:["MediaBlobs"],debug:t.debug(),autoConnect:t.autoConnect(),autoRefresh:t.autoRefresh()??!0,pageSize:50}),l=Te({items:()=>a.state().items,filterConfig:t.filterConfig,sortConfig:t.sortConfig});pe(()=>{const r=t.popupPreview(),v=t.actionMenu(),x=t.bulkActionMenu(),d=t.headerActionMenu(),y=t.confirmDialog();(r?.isOpen||v?.isOpen||x?.isOpen||d?.isOpen||y?.isOpen)&&(n.isDragSelecting()||n.dragStart())&&(n.setIsDragSelecting(!1),n.setDragStart(null),n.setDragEnd(null),o("🚫 Cancelled drag selection due to modal/overlay"))});const g=ln({onPreview:r=>t.setPopupPreview({item:r,isOpen:!0}),onToggleSelection:r=>n.toggleSelection(r.id),onSelectAll:r=>n.selectAll(r),onClearSelection:()=>n.clearSelection(),onEscape:()=>{t.popupPreview()?.isOpen?t.setPopupPreview(null):t.actionMenu()?.isOpen?t.setActionMenu(null):t.bulkActionMenu()?.isOpen?t.setBulkActionMenu(null):n.clearSelection()},onDelete:r=>{t.setConfirmDialog({isOpen:!0,title:"Delete Files",message:`Delete ${r.length} selected file${r.length!==1?"s":""}?`,items:r,onConfirm:()=>{o(`🗑️ Deleted ${r.length} items via keyboard`),n.clearSelection(),t.setConfirmDialog(null)}})},isTextInputFocused:()=>{const r=document.activeElement;return r&&(r.tagName==="INPUT"||r.tagName==="TEXTAREA"||r.isContentEditable||r.getAttribute("contenteditable")==="true")},getSelectedItems:()=>n.selectedItems(),getAllItems:()=>l.sortedData(),onLog:o}),[h,f]=M(new Set),m=r=>{h().has(r)||(f(v=>new Set([...v,r])),a.actions.getThumbnails(r),o(`🖼️ Requesting thumbnails for ${r.slice(0,8)}`))},i=(r,v,x)=>{x.shiftKey&&n.lastSelectedIndex()>=0?(x.preventDefault(),n.selectRange(n.lastSelectedIndex(),v,l.sortedData())):n.handleRowClick(r,v,x)},b=r=>{t.setPopupPreview({item:r,isOpen:!0}),o(`🖼️ Opened preview for: ${X(r)}`)},w=(r,v,x)=>{x.preventDefault(),x.stopPropagation();const d={x:x.clientX,y:x.clientY},y=n.selectedItems().size;y>1?(t.setBulkActionMenu({isOpen:!0,position:d}),o(`🖱️ Bulk context menu opened for ${y} items`)):(t.setActionMenu({item:r,isOpen:!0,position:d}),o(`🖱️ Context menu opened for: ${X(r)}`))},k=(r,v)=>{t.handleSort(r,v)},D=V(()=>{const r=p.responsiveColumnVisibility(),v=[];return r.thumbnail&&v.push({key:"thumbnail",title:"",width:60,render:x=>z(tt,{item:x,size:40,get apiBaseUrl(){return e.apiBaseUrl},onRequestThumbnails:m,get requestedThumbnails(){return h()},showIndicators:!0})}),r.name&&v.push({key:"name",title:"Name",sortable:!0,render:x=>(()=>{var d=pn();return u(d,()=>X(x)),P(()=>te(d,"title",X(x))),d})()}),r.blob_type&&v.push({key:"blob_type",title:"Type",width:100,sortable:!0}),r.mime&&v.push({key:"mime",title:"MIME Type",width:150,sortable:!0,render:x=>(()=>{var d=$e();return u(d,()=>x.mime||"unknown"),d})()}),r.id&&v.push({key:"id",title:"ID",width:200,sortable:!0,render:x=>(()=>{var d=hn();return u(d,()=>x.id),d})()}),r.size&&v.push({key:"size",title:"Size",width:100,sortable:!0,render:x=>(()=>{var d=$e();return u(d,()=>nt(x.size||0)),d})()}),r.parent_blob_id&&v.push({key:"parent_blob_id",title:"Parent",width:120,render:x=>(()=>{var d=$e();return u(d,()=>x.parent_blob_id?"Yes":"No"),d})()}),r.local_path&&v.push({key:"local_path",title:"Local Path",width:200,render:x=>(()=>{var d=$e();return u(d,()=>x.local_path||"None"),d})()}),r.created_at&&v.push({key:"created_at",title:"Created",width:140,sortable:!0,render:x=>{const d=Xe(x.created_at);return(()=>{var y=$e();return u(y,()=>d.relative),P(()=>te(y,"title",d.full)),y})()}}),r.updated_at&&v.push({key:"updated_at",title:"Updated",width:140,sortable:!0,render:x=>{if(!x.updated_at)return mn();const d=Xe(x.updated_at);return(()=>{var y=$e();return u(y,()=>d.relative),P(()=>te(y,"title",d.full)),y})()}}),r.actions&&v.push({key:"actions",title:(()=>{var x=bn();return x.$$click=d=>{d.stopPropagation();const y=d.currentTarget.getBoundingClientRect();t.setHeaderActionMenu({isOpen:!t.headerActionMenu()?.isOpen,position:{x:y.left+y.width/2,y:y.bottom+5}})},P(d=>F(x,`
        ...
        `);function An(){const{state:e,selection:t}=me();let n;const[o,c]=M({x:0,y:0}),s=f=>{f.key==="Escape"&&(f.preventDefault(),f.stopPropagation(),e.setBulkActionMenu(null))},p=f=>{n&&!n.contains(f.target)&&(f.preventDefault(),f.stopPropagation(),e.setBulkActionMenu(null))},a=()=>{if(!n)return;const f=200,m=140,i=e.bulkActionMenu()?.position;if(!i)return;const{x:b,y:w}=i;let k=b,D=w;const r=window.innerWidth,v=window.innerHeight;b+f>r&&(k=Math.max(10,r-f-10)),w+m>v&&(D=Math.max(10,w-m)),c({x:k,y:D})};pe(()=>{e.bulkActionMenu()?.isOpen?(document.addEventListener("keydown",s,!0),document.addEventListener("mousedown",p,!0),setTimeout(a,0)):(document.removeEventListener("keydown",s,!0),document.removeEventListener("mousedown",p,!0))}),fe(()=>{document.removeEventListener("keydown",s,!0),document.removeEventListener("mousedown",p,!0)});const l=async()=>{console.log("🗑️ Bulk download requested"),e.setBulkActionMenu(null)},g=()=>{console.log("🗑️ Bulk delete requested"),e.setBulkActionMenu(null)},h=()=>{t.clearSelection(),e.setBulkActionMenu(null)};return z(O,{get when(){return e.bulkActionMenu()?.isOpen},get children(){var f=Tn(),m=f.firstChild,i=m.firstChild,b=i.nextSibling,w=b.firstChild,k=w.nextSibling;k.nextSibling;var D=m.nextSibling,r=D.firstChild,v=r.nextSibling,x=v.nextSibling,d=x.nextSibling;f.$$click=$=>$.stopPropagation();var y=n;return typeof y=="function"?he(y,f):n=f,u(b,()=>t.selectedItems().size,k),r.addEventListener("mouseleave",$=>{$.target.style.background="transparent"}),r.addEventListener("mouseenter",$=>{$.target.style.background="#3a3a3a"}),r.$$click=l,v.addEventListener("mouseleave",$=>{$.target.style.background="transparent"}),v.addEventListener("mouseenter",$=>{$.target.style.background="#3a3a3a"}),v.$$click=h,d.addEventListener("mouseleave",$=>{$.target.style.background="transparent"}),d.addEventListener("mouseenter",$=>{$.target.style.background="#2a1a1a"}),d.$$click=g,P($=>F(f,`
          position: fixed;
          left: ${o().x}px;
          top: ${o().y}px;
          background: #1a1a1a;
      ...
      `);function jn(){const{state:e}=me();let t;const n=l=>{t&&!t.contains(l.target)&&(l.preventDefault(),l.stopPropagation(),e.setHeaderActionMenu(null))},o=l=>{l.key==="Escape"&&e.setHeaderActionMenu(null)};pe(()=>{e.headerActionMenu()?.isOpen?(document.addEventListener("mousedown",n,!0),document.addEventListener("keydown",o)):(document.removeEventListener("mousedown",n,!0),document.removeEventListener("keydown",o))}),fe(()=>{document.removeEventListener("mousedown",n,!0),document.removeEventListener("keydown",o)});const c=()=>{e.setIsFilterPanelOpen(!e.isFilterPanelOpen()),e.setHeaderActionMenu(null)},s=()=>{e.setIsSettingsPanelOpen(!e.isSettingsPanelOpen()),e.setHeaderActionMenu(null)},p=l=>{l.preventDefault(),l.stopPropagation();const g=e.viewMode(),h=["compact","default","detailed"],m=(h.indexOf(g)+1)%h.length,i=h[m];e.setViewMode(i)},a=()=>{e.updateFilter("name",""),e.updateFilter("mime",""),e.updateFilter("blobType",""),e.updateFilter("minSize",0),e.updateFilter("maxSize",1e8),e.updateFilter("hasParent","all"),e.updateFilter("hasLocalPath","all"),e.setHeaderActionMenu(null)};return z(O,{get when(){return e.headerActionMenu()?.isOpen},get children(){return[(()=>{var l=Kn(),g=l.firstChild,h=g.firstChild;h.firstChild;var f=h.nextSibling,m=f.nextSibling,i=m.nextSibling,b=i.firstChild,w=b.firstChild,k=w.nextSibling,D=i.nextSibling;D.firstChild;var r=t;return typeof r=="function"?he(r,l):t=l,h.$$click=c,u(h,z(O,{get when(){return e.isFilterPanelOpen()},get children(){return Ge()}}),null),f.$$click=a,i.$$click=p,u(k,()=>e.viewMode()),D.$$click=s,u(D,z(O,{get when(){return e.isSettingsPanelOpen()},get children(){return Ge()}}),null),P(v=>F(l,`
          position: fixed;
