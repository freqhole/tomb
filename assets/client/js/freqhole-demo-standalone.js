import{d as se,c as I,t as k,a as Oe,b as L,e as me,s as U,o as ge,f as xe,g as ve,h as G,i as S,j as ct,u as ut,k as l,m as Z,F as pe,S as A,l as le,n as $e,p as ft,r as gt}from"./web-WRO-G0Y6.js";import{u as Le}from"./thumbnail-utils-sa3o0-on.js";import{u as pt}from"./useThumbnail-i3_56dY5.js";import{f as qe}from"./date-utils-CshQIybG.js";import"./websocket-client-CzcG2k5P.js";import"./types-DDODKsJP.js";function ne(e){if(e.metadata&&typeof e.metadata=="object"){const t=e.metadata;if(t.originalName||t.filename||t.original_filename||t.file_name||t.name)return t.originalName||t.filename||t.original_filename||t.file_name||t.name}return e.local_path?.split("/").pop()||`${e.sha256?.slice(0,8)||e.id.slice(0,8)}...${e.sha256?.slice(-4)||e.id.slice(-4)}`}var ht=k(`<div title="Drag to resize • Drag far to close panel"><div class=resize-handle-indicator></div><div class=resize-handle-hint>Drag to resize • Drag far to close</div><style>
        .resize-handle:hover,
