import{d as ce,t as C,a as H,c as P,b as L,s as D,e as w,i as l,f as S,S as te,F as G,g as K,o as _e,m as de,u as Ke,h as xt,r as mt}from"./web-BLoVs608.js";var vt=C(`<div title="Drag to resize panel"><div class=resize-handle-indicator style="content:'';position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width:2px;height:40px;background:#4a4a4a;border-radius:1px;transition:background-color 0.2s ease;"></div><style>
        .resize-handle:hover,
      ...
      `;return s!==a.e&&L(i,a.e=s),a.t=D(i,c,a.t),a},{e:void 0,t:void 0}),i})()}ce(["mousedown"]);function Ge(e){const[i,a]=w(e.initialWidth),[s,c]=w(!1),F=e.minWidth||300,b=e.maxWidth||800;return{width:i,setWidth:a,isDragging:s,handleMouseDown:(I,A="right")=>{I.preventDefault(),c(!0),document.body.classList.add("resizing");const y=I.clientX,R=i(),U=B=>{const f=B.clientX-y,_=A==="right"?Math.max(F,Math.min(b,R-f)):Math.max(F,Math.min(b,R+f));a(_),e.onWidthChange?.(_)},V=()=>{c(!1),document.body.classList.remove("resizing"),document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",V)};document.addEventListener("mousemove",U),document.addEventListener("mouseup",V)}}}var $t=C('<button class=panel-close-button style="position:absolute;top:10px;right:10px;background:transparent;border:none;color:#888;cursor:pointer;font-size:14px;padding:4px 8px;border-radius:4px;transition:background-color 0.2s;">← Hide Browse'),pt=C('<div><div class=filter-section style=margin-bottom:24px;><h3 style="margin:0 0 12px 0;font-size:16px;color:#e0e0e0;">🔍 Name Search</h3><input class=filter-input type=text placeholder="Search by filename..."style="width:100%;padding:8px;background:#1a1a1a;border:1px solid #3a3a3a;border-radius:4px;color:#e0e0e0;font-size:14px;"></div><style>');function wt(e){const i=Ge({initialWidth:e.initialWidth,minWidth:300,maxWidth:800,onWidthChange:e.onWidthChange});return(()=>{var a=pt(),s=a.firstChild,c=s.firstChild,F=c.nextSibling,b=s.nextSibling;return l(a,S(te,{get when(){return e.isOpen},get children(){var g=$t();return H(g,"click",e.onTogglePanel),g}}),s),F.$$input=g=>e.onFilterChange("name",g.currentTarget.value),l(a,S(je,{position:"right",get isDragging(){return i.isDragging()},onMouseDown:g=>i.handleMouseDown(g,"left")}),b),l(b,()=>`
      ...
      `),P(g=>{var I=`browse-panel ${e.isOpen?"":"collapsed"} ${i.isDragging()?"resizing":""}`,A=`
        width: ${i.width()}px;
        background: #2a2a2a;
      ...
      `),P(t=>{var M=`filter-panel ${e.isOpen?"":"collapsed"} ${s.isDragging()?"resizing":""}`,Z=`
        width: ${s.width()}px;
        background: #2a2a2a;
      ...
      `,q=F(e.connectionStatus),ee=e.connectionStatus==="Connected",Pe=e.connectionStatus==="Disconnected",Fe=`toggle-button ${e.autoConnect?"active":""}`,st=`
            ...
            font-size: 14px;
            transition: all 0.2s;
          `,Oe=`column-settings ${i()?"":"collapsed"}`,ht=`
          ...
          `,Ee=`toggle-button ${e.debug?"active":""}`,bt=`
              ...
              font-size: 12px;
              transition: all 0.2s;
            `;return M!==t.e&&L(b,t.e=M),t.t=D(b,Z,t.t),t.a=D(U,q,t.a),ee!==t.o&&(B.disabled=t.o=ee),Pe!==t.i&&(f.disabled=t.i=Pe),Fe!==t.n&&L(h,t.n=Fe),t.s=D(h,st,t.s),Ie!==t.h&&L(d,t.h=Ie),t.r=D(d,dt,t.r),We!==t.d&&L(J,t.d=We),t.l=D(J,ct,t.l),Le!==t.u&&L(Y,t.u=Le),t.c=D(Y,ut,t.c),Ae!==t.w&&L(T,t.w=Ae),t.m=D(T,gt,t.m),Ue!==t.f&&L(r,t.f=Ue),t.y=D(r,ft,t.y),Oe!==t.g&&L(E,t.g=Oe),t.p=D(E,ht,t.p),Ee!==t.b&&L(be,t.b=Ee),t.T=D(be,bt,t.T),t},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0,m:void 0,f:void 0,y:void 0,g:void 0,p:void 0,b:void 0,T:void 0}),P(()=>A.value=e.wsUrl),P(()=>O.value=e.filterConfig.mime),P(()=>ie.value=e.filterConfig.blobType),P(()=>re.value=e.filterConfig.minSize),P(()=>X.value=e.filterConfig.maxSize),P(()=>ge.value=e.filterConfig.hasParent),P(()=>se.value=e.filterConfig.hasLocalPath),b})()}ce(["click","input"]);const Ce={name:"dark",colors:{background:"#1a1a1a",text:"#e0e0e0",border:"#3a3a3a",header:"#2a2a2a",hover:"#2a2a2a",selected:"#0070f3"}},Dt={dark:Ce,light:{name:"light",colors:{background:"#ffffff",text:"#333333",border:"#e0e0e0",header:"#f5f5f5",hover:"#f5f5f5",selected:"#0070f3"}}};function Rt(e){const[i,a]=w(e.initialSort||{field:"id",direction:"asc"}),[s,c]=w(new Set),[F,b]=w(!1),g=e.getItemId||(f=>f.id||String(f)),I=K(()=>{const f=i();return[...e.data].sort((W,h)=>{const x=W[f.field],v=h[f.field];let z=0;return x<v?z=-1:x>v&&(z=1),f.direction==="desc"?z*-1:z})});return{sortConfig:i,selectedItems:s,isDragSelecting:F,sortedData:I,handleSort:f=>{const _=i(),W=_.field===f&&_.direction==="asc"?"desc":"asc";a({field:f,direction:W})},toggleSelection:f=>{const _=new Set(s());_.has(f)?_.delete(f):_.add(f),c(_)},clearSelection:()=>{c(new Set)},selectAll:()=>{const f=new Set(e.data.map(g));c(f)},isSelected:f=>s().has(f),selectRange:(f,_)=>{const W=new Set(s()),h=Math.min(f,_),x=Math.max(f,_);for(let v=h;v<=x;v++)if(v<e.data.length&&e.data[v]!=null){const z=g(e.data[v]);W.add(z)}c(W)},setIsDragSelecting:b,getItemId:g}}var Tt=C("<div class=grid-row>"),Pt=C("<div class=grid-cell>"),Ve=C("<div class=grid-content>"),Ft=C("<div><div class=grid-header></div><div class=grid-body style=flex:1;overflow-y:auto;position:relative;></div><style>"),It=C("<span style=font-size:12px;>"),Wt=C("<div><span>"),Lt=C("<div>");function Be(e){let i;return _e(()=>{e.onRowMount&&e.onRowMount(e.item)}),(()=>{var a=Tt();a.$$contextmenu=c=>e.onContextMenu?.(e.item,e.index,c),a.$$mousedown=c=>e.onRowMouseDown?.(e.item,e.index,c),a.$$dblclick=c=>e.onRowDoubleClick?.(e.item,e.index,c),a.$$click=c=>e.onRowClick?.(e.item,e.index,c);var s=i;return typeof s=="function"?Ke(s,a):i=a,l(a,S(G,{get each(){return e.columns},children:c=>(()=>{var F=Pt();return l(F,(()=>{var b=de(()=>!!c.render);return()=>b()?c.render(e.item,e.index):String(e.item[c.key]||"")})()),P(b=>D(F,`
      ...
      `,c)),a})()}function At(e){const[i,a]=w(),[s,c]=w(0),[F,b]=w(0),g=e.rowHeight||50,I=e.headerHeight||60,A=e.virtualizeThreshold||100,y=Rt({data:e.data,getItemId:e.getItemId,initialSort:e.sortField?{field:e.sortField,direction:e.sortDirection||"asc"}:void 0}),R=K(()=>{if(typeof e.theme=="string"){const h=Dt[e.theme];return h||Ce}return e.theme?e.theme:Ce}),U=K(()=>e.data.length>A),V=K(()=>{if(!U())return e.data.map(($,O)=>({item:$,index:O}));if(!i())return[];const x=g,v=s(),z=F(),d=Math.floor(v/x),m=Math.min(e.data.length-1,Math.ceil((v+z)/x)+5),k=[];for(let $=Math.max(0,d-5);$<=m;$++)$<e.data.length&&e.data[$]!=null&&k.push({item:e.data[$],index:$});return k}),B=K(()=>e.data.length*g),f=h=>{const x=h.target;c(x.scrollTop)},_=h=>{if(y.handleSort(h),e.onSort){const x=y.sortConfig();e.onSort(x.field,x.direction)}},W=(h,x,v)=>{const z=y.getItemId(h);if(v.ctrlKey||v.metaKey)y.toggleSelection(z);else if(v.shiftKey&&y.selectedItems().size>0){const d=e.data,m=Array.from(y.selectedItems()).pop();if(m){const k=d.findIndex($=>y.getItemId($)===m);k!==-1&&y.selectRange(k,x)}}else y.clearSelection(),y.toggleSelection(z);e.onRowClick?.(h,x,v)};return _e(()=>{const h=i();if(!h)return;const x=new ResizeObserver(v=>{for(const z of v)b(z.contentRect.height)});x.observe(h),xt(()=>{x.disconnect()})}),(()=>{var h=Ft(),x=h.firstChild,v=x.nextSibling,z=v.nextSibling;return l(x,S(G,{get each(){return e.columns},children:d=>(()=>{var m=Wt(),k=m.firstChild;return m.$$click=()=>d.sortable&&_(d.key),l(k,()=>d.title),l(m,S(te,{get when(){return de(()=>!!d.sortable)()&&y.sortConfig().field===d.key},get children(){var $=It();return l($,()=>y.sortConfig().direction==="asc"?"↑":"↓"),$}}),null),P($=>{var O=`grid-header-cell ${d.sortable?"sortable":""}`,ne=`
                ...
                align-items: center;
                gap: 8px;
              `;return O!==$.e&&L(m,$.e=O),$.t=D(m,ne,$.t),$},{e:void 0,t:void 0}),m})()})),v.addEventListener("scroll",f),Ke(a,v),l(v,S(te,{get when(){return U()},get fallback(){return(()=>{var d=Ve();return l(d,S(G,{get each(){return e.data},children:(m,k)=>S(Be,{item:m,get index(){return k()},get columns(){return e.columns},get isSelected(){return y.isSelected(y.getItemId(m))},onRowClick:W,get onRowDoubleClick(){return e.onRowDoubleClick},get onRowMouseDown(){return e.onRowMouseDown},get onRowMount(){return e.onRowMount},get onContextMenu(){return e.onContextMenu},get theme(){return R()},rowHeight:g})})),d})()},get children(){var d=Ve();return l(d,S(G,{get each(){return V()},children:m=>(()=>{var k=Lt();return l(k,S(Be,{get item(){return m.item},get index(){return m.index},get columns(){return e.columns},get isSelected(){return y.isSelected(y.getItemId(m.item))},onRowClick:W,get onRowDoubleClick(){return e.onRowDoubleClick},get onRowMouseDown(){return e.onRowMouseDown},get onRowMount(){return e.onRowMount},get onContextMenu(){return e.onContextMenu},get theme(){return R()},rowHeight:g})),P($=>D(k,`
                    position: absolute;
                    top: ${m.index*g}px;
                    left: 0;
                    right: 0;
                  `,$)),k})()})),P(m=>D(d,`height: ${B()}px; position: relative;`,m)),d}})),l(z,()=>`
        .grid-row:hover {
      ...
      `),P(d=>{var m=`infinite-data-grid ${e.className||""}`,k=`
        height: 100%;
        display: flex;
