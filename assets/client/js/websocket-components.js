import{d as we,c as u,g as T,t as d,k as r,i as g,S as h,b as oe,e as ne,F as Se,m as Ce}from"./web-D0fRMFns.js";import{c as ke}from"./index-BR1eXDF4.js";import{W as Me}from"./websocket-status-BrBvaJs0.js";import{C as c,W as Be}from"./websocket-client-Dbi0hGVw.js";import"./types-CGPwAX3k.js";var De=d("<button>Disconnect"),Ee=d("<div class=error-message>"),Ue=d("<div class=debug-log>"),ze=d("<div class=upload-progress>"),Ae=d('<div><div class=upload-controls><div class=file-input-wrapper><input type=file id=file-input class=file-input multiple><label for=file-input><svg class=upload-icon fill=none stroke=currentColor viewBox="0 0 24 24"><path stroke-linecap=round stroke-linejoin=round stroke-width=2 d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg></label></div><div class=upload-hint>'),Le=d(`<div><style>
        .container {
          padding: 16px;
