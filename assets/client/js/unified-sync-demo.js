import{d as pt,c as C,g as We,o as bt,f as St,t as I,k as S,i as x,S as z,b as K,F as we,e as le,l as Ue}from"./web-Bmt1sUg0.js";import{c as wt}from"./index-CuXI0cIU.js";import{A as vt}from"./api-client-oDSgDTkX.js";import{C as X,W as $t}from"./websocket-client-BIZ3xMI1.js";import{h as kt,g as _t}from"./sync-progress-CeO0DFFv.js";import{W as Dt}from"./websocket-status-B6AILaLV.js";import"./types-DDODKsJP.js";import"./sync-constants-QglVsuEd.js";import"./blob-client-DCiVtQuT.js";//! Unified Sync System - Core Types
//!
...
var v=(s=>(s.Never="never",s.InProgress="in_progress",s.Complete="complete",s.Failed="failed",s.Paused="paused",s))(v||{}),p=(s=>(s.Started="started",s.Progress="progress",s.DomainCompleted="domain_completed",s.AllCompleted="all_completed",s.Failed="failed",s.Paused="paused",s.Resumed="resumed",s.BinaryProgress="binary_progress",s.AutoSyncTriggered="auto_sync_triggered",s.ConnectionChanged="connection_changed",s))(p||{});//! Debug Logging Utility
//!
//! Centralized debug logging for the unified sync system.
//! All console output should go through this utility.
const Ct={enabled:!1,timestamps:!0,levels:{info:!0,warn:!0,error:!0,debug:!1}};let L={...Ct};function xt(s){L={...L,...s}}function Oe(){L.enabled=!0}function Fe(){L.enabled=!1}function $e(){return L.timestamps?`[${new Date().toLocaleTimeString()}] `:""}function d(s,...e){L.enabled&&L.levels.info&&console.log(`${$e()}${s}`,...e)}function ve(s,...e){L.enabled&&L.levels.warn&&console.warn(`${$e()}${s}`,...e)}function N(s,...e){L.enabled&&L.levels.error&&console.error(`${$e()}${s}`,...e)}//! Domain Configurations
//!
...
const It={domain:"music",endpoints:{list:"/api/media/songs",item:"/api/media/songs/{id}",sync:"/api/sync/songs",binary:"/api/blobs/{blob_id}"},defaultOptions:{pageSize:50,includeBinaryData:!0,forceFullSync:!1},binaryConfig:{priorityMimeTypes:["audio/","image/"],maxFileSize:50*1024*1024,batchSize:3},transforms:{fromApi:s=>({id:s.id,name:s.name,artist:s.artist,album:s.album,duration:s.duration,blob_id:s.blob_id,created_at:s.created_at,updated_at:s.updated_at,metadata:s.metadata||{}}),toStorage:s=>({...s,_sync_version:1,_last_modified:new Date().toISOString()}),fromStorage:s=>{const{_sync_version:e,_last_modified:t,_domain:i,_stored_at:n,...o}=s;return o}}},Tt={domain:"photos",endpoints:{list:"/api/photos",item:"/api/photos/{id}",sync:"/api/sync/photos",binary:"/api/blobs/{blob_id}"},defaultOptions:{pageSize:100,includeBinaryData:!0,forceFullSync:!1},binaryConfig:{priorityMimeTypes:["image/jpeg","image/png","image/webp"],maxFileSize:20*1024*1024,batchSize:5},transforms:{fromApi:s=>({id:s.id,title:s.title,description:s.description,width:s.width,height:s.height,blob_id:s.blob_id,thumbnail_blob_id:s.thumbnail_blob_id,created_at:s.created_at,updated_at:s.updated_at,location:s.location,camera_info:s.camera_info,metadata:s.metadata||{}}),toStorage:s=>({...s,_sync_version:1,_last_modified:new Date().toISOString()}),fromStorage:s=>{const{_sync_version:e,_last_modified:t,_domain:i,_stored_at:n,...o}=s;return o}}},Mt={domain:"documents",endpoints:{list:"/api/documents",item:"/api/documents/{id}",sync:"/api/sync/documents",binary:"/api/blobs/{blob_id}"},defaultOptions:{pageSize:25,includeBinaryData:!1,forceFullSync:!1},binaryConfig:{priorityMimeTypes:["application/pdf","text/","application/msword"],maxFileSize:100*1024*1024,batchSize:2},transforms:{fromApi:s=>({id:s.id,title:s.title,content:s.content,author:s.author,mime_type:s.mime_type,file_size:s.file_size,blob_id:s.blob_id,version:s.version,created_at:s.created_at,updated_at:s.updated_at,tags:s.tags||[],metadata:s.metadata||{}}),toStorage:s=>({...s,_sync_version:1,_last_modified:new Date().toISOString()}),fromStorage:s=>{const{_sync_version:e,_last_modified:t,_domain:i,_stored_at:n,...o}=s;return o}}},At={domain:"videos",endpoints:{list:"/api/videos",item:"/api/videos/{id}",sync:"/api/sync/videos",binary:"/api/blobs/{blob_id}"},defaultOptions:{pageSize:20,includeBinaryData:!1,forceFullSync:!1},binaryConfig:{priorityMimeTypes:["video/mp4","video/webm","image/"],maxFileSize:500*1024*1024,batchSize:1},transforms:{fromApi:s=>({id:s.id,title:s.title,description:s.description,duration:s.duration,width:s.width,height:s.height,blob_id:s.blob_id,thumbnail_blob_id:s.thumbnail_blob_id,preview_blob_id:s.preview_blob_id,created_at:s.created_at,updated_at:s.updated_at,quality:s.quality,codec:s.codec,metadata:s.metadata||{}}),toStorage:s=>({...s,_sync_version:1,_last_modified:new Date().toISOString()}),fromStorage:s=>{const{_sync_version:e,_last_modified:t,_domain:i,_stored_at:n,...o}=s;return o}}},Nt={music:It,photos:Tt,documents:Mt,videos:At};function Le(s){return{...Nt}}//! Service Worker Sync Types
//!
...
class zt{storage;wsClient;apiClient;config;domainConfigs;currentStatus;currentProgress;activeSyncs=new Set;eventListeners=new Map;autoSyncEnabled=!1;autoSyncTimeouts=new Map;serviceWorkerSyncManager=null;constructor(e,t,i,n){this.storage=e,this.wsClient=t,this.apiClient=i,this.config=n,this.domainConfigs=Le(),this.currentStatus={music:v.Never,photos:v.Never,documents:v.Never,videos:v.Never},this.currentProgress={music:this.createEmptyProgress(),photos:this.createEmptyProgress(),documents:this.createEmptyProgress(),videos:this.createEmptyProgress()}}async initialize(){if(d("🚀 Initializing UnifiedSyncManager..."),await this.storage.initialize(),this.setupWebSocketListeners(),await this.loadSyncStates(),this.config.autoSync.enabled&&this.enableAutoSync(!0),this.config.serviceWorker?.enabled&&Pt())try{this.serviceWorkerSyncManager=Bt(this,this.config.serviceWorker),await this.serviceWorkerSyncManager.initialize(),console.log("✅ Service Worker sync initialized")}catch(e){console.warn("⚠️ Service Worker sync initialization failed:",e)}d("✅ UnifiedSyncManager initialized")}async syncAll(e={}){d("🔄 Starting sync all domains...");const t=Date.now(),i=e.domains||Object.keys(this.domainConfigs),o=(e.priorityOrder||i).filter(y=>i.includes(y));i.forEach(y=>{o.includes(y)||o.push(y)});const r=[];let a=0;const c=[];this.emitEvent({type:p.Started,timestamp:new Date,domain:o[0],isFullSync:e.forceFullSync||!1});for(const y of o)try{const f={forceFullSync:e.forceFullSync,includeBinaryData:e.includeBinaryData},k=await this.syncDomain(y,f);r.push(k),a+=k.itemsSynced,k.errors.length>0&&c.push(...k.errors)}catch(f){console.error(`❌ Failed to sync domain ${y}:`,f);const k={code:"DOMAIN_SYNC_FAILED",message:`Failed to sync ${y}: ${f instanceof Error?f.message:String(f)}`,details:f};c.push(k)}const g=Date.now()-t,w={domain:"music",status:c.length>0?v.Failed:v.Complete,itemsSynced:a,totalItems:r.reduce((y,f)=>y+f.totalItems,0),duration:g,errors:c,binaryStats:this.aggregateBinaryStats(r)};return this.emitEvent({type:p.AllCompleted,timestamp:new Date,result:w}),console.log(`✅ Sync all completed: ${a} items in ${g}ms`),w}async syncDomain(e,t={}){if(d(`🔄 Starting sync for domain: ${e}`),this.activeSyncs.has(e))throw new Error(`Sync already in progress for domain: ${e}`);this.activeSyncs.add(e),this.updateStatus(e,v.InProgress);const i=Date.now(),n=[];try{this.emitEvent({type:p.Started,timestamp:new Date,domain:e,isFullSync:t.forceFullSync||!1});const o=await this.syncStructuredData(e,t);let r;t.includeBinaryData&&e==="music"&&(d("🔄 Starting binary data sync..."),r=await this.syncBinaryData());const a=Date.now()-i,c={domain:e,status:v.Complete,itemsSynced:o.itemsSynced,totalItems:o.totalItems,duration:a,binaryStats:r,errors:n};return this.updateStatus(e,v.Complete),this.updateProgress(e,{status:v.Complete,progress:100,itemsProcessed:c.itemsSynced,totalItems:c.totalItems,currentBatch:1,totalBatches:1,currentOperation:"Complete"}),this.emitEvent({type:p.DomainCompleted,timestamp:new Date,domain:e,result:c}),console.log(`✅ Domain ${e} sync completed: ${c.itemsSynced} items`),c}catch(o){N(`❌ Domain ${e} sync failed:`,o);const r={code:"SYNC_FAILED",message:o instanceof Error?o.message:String(o),details:o};n.push(r),this.updateStatus(e,v.Failed),this.emitEvent({type:p.Failed,timestamp:new Date,domain:e,error:r});const a=Date.now()-i;return{domain:e,status:v.Failed,itemsSynced:0,totalItems:0,duration:a,errors:n}}finally{this.activeSyncs.delete(e)}}async getBlobUrl(e){try{const t=await this.storage.getBinaryData(e);if(t){const n=(await this.storage.getItems("documents")).find(o=>o.id===e);if(n){const o=new Blob([t],{type:n.mime||"application/octet-stream"});return URL.createObjectURL(o)}}return`${this.config.apiBaseUrl}/blobs/${e}`}catch(t){return console.error(`Failed to get blob URL for ${e}:`,t),null}}enableAutoSync(e){d(`${e?"🔄 Enabling":"⏸️ Disabling"} auto-sync...`),this.autoSyncEnabled=e,e?this.config.autoSync.periodicInterval&&this.setupPeriodicSync():(this.autoSyncTimeouts.forEach(t=>clearTimeout(t)),this.autoSyncTimeouts.clear())}getStatus(){return{...this.currentStatus}}getProgress(){return{music:{...this.currentProgress.music},photos:{...this.currentProgress.photos},documents:{...this.currentProgress.documents},videos:{...this.currentProgress.videos}}}async destroyAll(){d("💥 Starting complete system teardown...");try{d("⏸️ Disabling auto-sync..."),this.enableAutoSync(!1),d("🛑 Clearing active syncs..."),this.activeSyncs.clear(),d("🔄 Resetting sync status..."),this.currentStatus={music:v.Never,photos:v.Never,documents:v.Never,videos:v.Never},this.currentProgress={music:this.createEmptyProgress(),photos:this.createEmptyProgress(),documents:this.createEmptyProgress(),videos:this.createEmptyProgress()},d("🗑️ Destroying storage database..."),await this.storage.destroyAll(),d("✅ Storage database destroyed"),d("🗑️ Complete system teardown successful"),this.emitEvent({type:p.AllCompleted,timestamp:new Date,result:{domain:"music",status:v.Complete,itemsSynced:0,totalItems:0,duration:0,errors:[]}})}catch(e){throw N("❌ Failed to destroy system:",e),new Error(`System teardown failed: ${e}`)}}async getMediaBlobs(){try{return(await this.storage.getItems("documents")).filter(t=>t.mime&&t.mime.startsWith("image/"))}catch(e){return console.error("Failed to get media blobs:",e),[]}}async hasBinaryData(e){try{return!!await this.storage.getBinaryData(e)}catch(t){return N("Failed to check binary data:",t),!1}}on(e,t){this.eventListeners.has(e)||this.eventListeners.set(e,new Set),this.eventListeners.get(e).add(t)}off(e,t){const i=this.eventListeners.get(e);i&&i.delete(t)}async getServiceWorkerSyncManager(){return this.serviceWorkerSyncManager}async destroy(){console.log("🧹 Destroying UnifiedSyncManager..."),this.enableAutoSync(!1),this.serviceWorkerSyncManager&&(await this.serviceWorkerSyncManager.destroy(),this.serviceWorkerSyncManager=null),this.eventListeners.clear(),this.activeSyncs.clear(),console.log("✅ UnifiedSyncManager destroyed")}async syncStructuredData(e,t){const i=this.domainConfigs[e];if(e==="music")return this.syncMusicDomain(t);const n=t.pageSize||i.defaultOptions.pageSize||50;let o=null;t.forceFullSync||(o=null);let r=0,a=0,c=0,g=!0;for(;g&&(!t.maxItems||a<t.maxItems);){r++,console.log(`📄 Syncing ${e} page ${r}...`);const b=new URLSearchParams({page_size:n.toString(),...o&&{cursor:o}}),w=`${this.config.apiBaseUrl}${i.endpoints.sync}?${b}`,y=await fetch(w,{method:"GET",headers:{"Content-Type":"application/json",...this.config.authToken&&{Authorization:`Bearer ${this.config.authToken}`}}});if(!y.ok)throw new Error(`API request failed: ${y.status} ${y.statusText}`);const f=await y.json(),k=f.items||[];if(c=f.total_count||k.length,k.length===0){g=!1;break}const J=k.map(q=>i.transforms.toStorage(i.transforms.fromApi(q)));if(await this.storage.storeItems(e,J),a+=k.length,this.updateProgress(e,{status:v.InProgress,progress:Math.min(100,a/c*100),itemsProcessed:a,totalItems:c,currentBatch:r,totalBatches:Math.ceil(c/n),currentOperation:`Syncing ${e} data`}),this.emitEvent({type:p.Progress,timestamp:new Date,domain:e,progress:this.currentProgress[e]}),o=f.next_cursor,g=!!o&&k.length===n,t.maxItems&&a>=t.maxItems)break}return{itemsSynced:a,totalItems:c}}async syncMusicDomain(e){d("🎵 Starting unified music domain sync...");let t=0,i=0;d("🎵 Syncing songs...");const n=await this.syncMusicDataType("songs",e);t+=n.itemsSynced,i+=n.totalItems,console.log("📋 Syncing playlists...");const o=await this.syncMusicDataType("playlists",e);t+=o.itemsSynced,i+=o.totalItems,console.log("🔗 Syncing playlist songs...");const r=await this.syncMusicDataType("playlist-songs",e);t+=r.itemsSynced,i+=r.totalItems,console.log("📦 Syncing media blobs...");const a=await this.syncMediaBlobs(e);return t+=a.itemsSynced,i+=a.totalItems,console.log(`✅ Unified music sync complete: ${t} total items`),{itemsSynced:t,totalItems:i}}async syncMusicDataType(e,t){const i=Math.min(t.pageSize||50,100),n=e==="songs"?"/api/sync/songs":e==="playlists"?"/api/sync/playlists":"/api/sync/playlist-songs";let o=null,r=0,a=!0,c=0;const g=20;for(d(`🚀 Starting ${e} sync with pageSize: ${i}`);a&&c<g&&(!t.maxItems||r<t.maxItems);){c++;try{const b=new URLSearchParams({page_size:i.toString()});o!==null&&b.set("cursor",o);const w=`${this.config.apiBaseUrl}${n}?${b}`;d(`🔄 Syncing ${e} page ${c}/${g} from: ${w}`);const y=await fetch(w,{method:"GET",headers:{"Content-Type":"application/json",...this.config.authToken&&{Authorization:`Bearer ${this.config.authToken}`}}});if(!y.ok)throw new Error(`Failed to sync ${e}: ${y.status} ${y.statusText}`);const f=await y.json(),k=f.items||[],J=f.pagination||{};if(d(`📊 ${e} page ${c} response:`,{itemsCount:k.length,hasMore:J.has_more||!1,nextCursor:J.next_cursor||null}),k.length===0){d(`📭 No more ${e} items, stopping sync`);break}const q=JSON.stringify(k).length;q>10*1024*1024&&ve(`⚠️ Large ${e} response: ${q} bytes`);const te=this.domainConfigs.music,re=k.map(G=>{try{return te.transforms.toStorage(te.transforms.fromApi(G))}catch(de){return N(`❌ Transform error for ${e} item:`,G,de),null}}).filter(G=>G!==null);d(`🔄 Storing ${re.length} ${e} items to storage`),await this.storeToMusicTable(e,re),r+=k.length,a=J.has_more||!1,o=J.next_cursor||null,d(`✅ Synced ${e} page ${c}: ${k.length} items (total: ${r})`)}catch(b){N(`❌ Failed to sync ${e} page ${c}:`,b);break}}return d(`🎯 Completed ${e} sync: ${r} total items`),{itemsSynced:r,totalItems:r}}async syncMediaBlobs(e){const t=e.pageSize||50,i="/api/sync/media";let n=null,o=0,r=!0,a=0;for(;r&&(!e.maxItems||o<e.maxItems);){a++;const c=new URLSearchParams({page_size:t.toString(),include_data:"false"});n!==null&&c.set("cursor",n);const g=`${this.config.apiBaseUrl}${i}?${c}`;console.log(`🔄 Syncing media_blobs page ${a} from: ${g}`);const b=await fetch(g,{method:"GET",headers:{"Content-Type":"application/json",...this.config.authToken&&{Authorization:`Bearer ${this.config.authToken}`}}});if(!b.ok)throw new Error(`Failed to sync media_blobs: ${b.status} ${b.statusText}`);const w=await b.json(),y=w.items||[],f=w.pagination||{};if(console.log(`📊 media_blobs page ${a} response:`,{itemsCount:y.length,hasMore:f.has_more||!1,nextCursor:f.next_cursor||null}),y.length===0)break;console.log(`🔄 Storing ${y.length} media_blobs items to storage`),await this.storage.storeItemsToTable("media_blobs",y),o+=y.length,r=f.has_more||!1,n=f.next_cursor||null,console.log(`✅ Synced media_blobs page ${a}: ${y.length} items (total: ${o})`)}return console.log(`🎯 Completed media_blobs sync: ${o} total items`),{itemsSynced:o,totalItems:o}}async storeToMusicTable(e,t){const i=e==="songs"?"songs":e==="playlists"?"playlists":"playlist_songs";i==="songs"?await this.storage.storeItemsToTable("songs",t):i==="playlists"?await this.storage.storeItemsToTable("playlists",t):await this.storage.storeItemsToTable("playlist_songs",t)}async syncBinaryData(){const e=Date.now();let t=0,i=0,n=[];try{const o=await this.storage.getItems("documents");d(`📦 Found ${o.length} media blobs to check for binary data`);for(const c of o)try{if(await this.storage.getBinaryData(c.id)){d(`✅ Skipping ${c.id} - already cached`);continue}d(`🔄 Requesting binary data for blob ${c.id}...`);const b=await this.requestBinaryDataViaWebSocket(c.id);b&&(await this.storage.storeBinaryData(c.id,b),t++,i+=b.byteLength,d(`✅ Cached binary data for ${c.id} (${b.byteLength} bytes)`))}catch(g){const b=`Failed to sync binary data for ${c.id}: ${g}`;N(b),n.push(b)}const r=Date.now()-e,a=o.length-t-n.length;return d(`🎉 Binary sync complete: ${t} cached, ${a} skipped, ${n.length} failed, ${i} bytes in ${r}ms`),{cached:t,skipped:a,failed:n.length,bytesDownloaded:i}}catch(o){const r=`Binary sync failed: ${o}`;throw N(r),new Error(r)}}async requestBinaryDataViaWebSocket(e){return new Promise((t,i)=>{const n=setTimeout(()=>{i(new Error(`Timeout waiting for binary data for blob ${e}`))},1e4),o=this.config.websocketUrl||"ws://localhost:3000/ws",r=new WebSocket(o);r.onopen=()=>{d(`🔌 Binary WebSocket connected for blob ${e}`);const c=JSON.stringify({type:"GetMediaBlobData",data:{id:e}});d(`📤 Sending binary request for ${e}:`,c),r.send(c),d(`✅ Binary request sent for ${e}`)},r.onmessage=a=>{if(d(`🔍 Binary WebSocket message for ${e}:`,{dataType:typeof a.data,isArrayBuffer:a.data instanceof ArrayBuffer,isBlob:a.data instanceof Blob,size:a.data.byteLength||a.data.size||a.data.length,data:a.data instanceof ArrayBuffer?"ArrayBuffer":a.data instanceof Blob?"Blob":typeof a.data=="string"?a.data.substring(0,100):"Unknown"}),a.data instanceof ArrayBuffer)d(`📦 Received ArrayBuffer for ${e} (${a.data.byteLength} bytes)`),clearTimeout(n),r.close(),t(a.data);else if(a.data instanceof Blob)d(`📦 Received Blob for ${e} (${a.data.size} bytes), converting to ArrayBuffer...`),a.data.arrayBuffer().then(c=>{d(`✅ Converted Blob to ArrayBuffer for ${e} (${c.byteLength} bytes)`),clearTimeout(n),r.close(),t(c)}).catch(c=>{N(`❌ Failed to convert Blob to ArrayBuffer for ${e}:`,c),clearTimeout(n),r.close(),i(new Error(`Failed to convert Blob to ArrayBuffer: ${c}`))});else if(typeof a.data=="string")try{const c=JSON.parse(a.data);if(d(`📝 JSON response for ${e}:`,c),c.type==="Error"){clearTimeout(n),r.close(),i(new Error(`Server error: ${c.data.message}`));return}if(c.type==="Welcome"||c.type==="ConnectionStatus"){d(`ℹ️ Ignoring non-data response: ${c.type}`);return}}catch{d(`⚠️ Non-JSON string response for ${e}:`,a.data.substring(0,100))}},r.onerror=a=>{N(`❌ Binary WebSocket error for blob ${e}:`,a),d(`🔍 WebSocket state: readyState=${r.readyState}, url=${r.url}`),clearTimeout(n),i(new Error(`WebSocket error for blob ${e}`))},r.onclose=a=>{d(`🔌 Binary WebSocket closed for blob ${e}: code=${a.code}, reason='${a.reason}', wasClean=${a.wasClean}`),a.code!==1e3&&(ve(`⚠️ Binary WebSocket closed unexpectedly for blob ${e}: ${a.code} ${a.reason}`),clearTimeout(n),i(new Error(`WebSocket closed unexpectedly for blob ${e}: ${a.code} ${a.reason}`)))}})}setupWebSocketListeners(){}setupPeriodicSync(){if(!this.config.autoSync.periodicInterval)return;const e=this.config.autoSync.periodicInterval*60*1e3;for(const t of this.config.autoSync.domains){const i=setInterval(async()=>{console.log(`⏰ Periodic sync triggered for ${t}`),this.emitEvent({type:p.AutoSyncTriggered,timestamp:new Date,domain:t,trigger:"periodic"});try{await this.syncDomain(t,{includeBinaryData:!0})}catch(n){console.error(`Periodic sync failed for domain ${t}:`,n)}},e);this.autoSyncTimeouts.set(t,i)}}async loadSyncStates(){const e=await this.storage.getStats();for(const t of Object.keys(this.currentStatus))e.lastSyncTimes[t]&&(this.currentStatus[t]=v.Complete)}updateStatus(e,t){this.currentStatus[e]=t}updateProgress(e,t){this.currentProgress[e]=t}createEmptyProgress(){return{status:v.Never,progress:0,itemsProcessed:0,totalItems:0,currentBatch:0,totalBatches:0}}emitEvent(e){const t=this.eventListeners.get(e.type);t&&t.forEach(i=>{try{i(e)}catch(n){N("Error in sync event listener:",n)}})}aggregateBinaryStats(e){const t=e.map(i=>i.binaryStats).filter(i=>!!i);if(t.length!==0)return{cached:t.reduce((i,n)=>i+n.cached,0),skipped:t.reduce((i,n)=>i+n.skipped,0),failed:t.reduce((i,n)=>i+n.failed,0),bytesDownloaded:t.reduce((i,n)=>i+n.bytesDownloaded,0)}}}function Wt(s,e,t,i){return new zt(s,e,t,i)}//! Unified Storage Implementation
//!
...
class Ut{config;db=null;dbName;dbVersion;DOMAIN_TABLES={songs:"songs",playlists:"playlists",playlist_songs:"playlist_songs",media_blobs:"media_blobs",media_blob_data:"media_blob_data"};METADATA_STORE="sync_metadata";getMusicTables(){return["songs","playlists","playlist_songs"]}getDomainTable(e){switch(e){case"music":return"songs";case"photos":case"documents":case"videos":return"media_blobs";default:return"media_blobs"}}constructor(e){this.config=e,this.dbName=e.databaseName,this.dbVersion=e.version}async initialize(){return d(`📦 Initializing unified storage: ${this.dbName} v${this.dbVersion}`),new Promise((e,t)=>{const i=indexedDB.open(this.dbName,this.dbVersion);i.onerror=()=>{t(new Error(`Failed to open database: ${i.error?.message}`))},i.onsuccess=()=>{this.db=i.result,d("✅ Unified storage initialized"),e()},i.onupgradeneeded=n=>{const o=n.target.result;this.setupDatabase(o)}})}async storeItems(e,t){if(!this.db)throw new Error("Storage not initialized");if(e==="music")return this.storeMusicItems(t);const i=this.getDomainTable(e),o=this.db.transaction([i],"readwrite").objectStore(i);for(const r of t)await this.promisifyRequest(o.put({...r,_domain:e,_stored_at:new Date().toISOString()}));await this.updateDomainMetadata(e,{last_sync:new Date().toISOString(),item_count:await this.countItems(e)}),d(`💾 Stored ${t.length} items for domain: ${e}`)}async storeItemsToTable(e,t){if(!this.db)throw new Error("Storage not initialized");const n=this.db.transaction([e],"readwrite").objectStore(e);for(const o of t)await this.promisifyRequest(n.put({...o,_stored_at:new Date().toISOString()}));d(`💾 Stored ${t.length} items to table: ${e}`)}async storeMusicItems(e){if(!this.db)throw new Error("Storage not initialized");const t=e.filter(a=>!a._data_type||a._data_type==="songs"),i=e.filter(a=>a._data_type==="playlists"),n=e.filter(a=>a._data_type==="playlist-songs"),o=this.getMusicTables(),r=this.db.transaction(o,"readwrite");if(t.length>0){const a=r.objectStore("songs");for(const c of t){const{_data_type:g,...b}=c;await this.promisifyRequest(a.put({...b,_stored_at:new Date().toISOString()}))}}if(i.length>0){const a=r.objectStore("playlists");for(const c of i){const{_data_type:g,...b}=c;await this.promisifyRequest(a.put({...b,_stored_at:new Date().toISOString()}))}}if(n.length>0){const a=r.objectStore("playlist_songs");for(const c of n){const{_data_type:g,...b}=c;await this.promisifyRequest(a.put({...b,_stored_at:new Date().toISOString()}))}}d(`🎵 Stored music: ${t.length} songs, ${i.length} playlists, ${n.length} playlist_songs`)}async getItems(e,t={}){if(!this.db)throw new Error("Storage not initialized");if(e==="music")return this.getMusicItems(t);const i=this.getDomainTable(e),r=this.db.transaction([i],"readonly").objectStore(i).getAll(),a=await this.promisifyRequest(r);return this.applyQueryOptions(a,t)}async getMusicItems(e={}){if(!this.db)throw new Error("Storage not initialized");const t=this.getMusicTables(),r=this.db.transaction(t,"readonly").objectStore("songs").getAll(),a=await this.promisifyRequest(r);return this.applyQueryOptions(a,e)}applyQueryOptions(e,t){let i=e;if(t.where&&(i=i.filter(n=>Object.entries(t.where).every(([o,r])=>n[o]===r))),t.sortBy){const n=t.sortBy,o=t.sortOrder||"asc";i.sort((r,a)=>{const c=r[n],g=a[n];return c<g?o==="asc"?-1:1:c>g?o==="asc"?1:-1:0})}if(t.offset||t.limit){const n=t.offset||0,o=t.limit?n+t.limit:void 0;i=i.slice(n,o)}return i}async getItem(e,t){if(!this.db)throw new Error("Storage not initialized");const i=this.getDomainTable(e),r=this.db.transaction([i],"readonly").objectStore(i).get(t);return await this.promisifyRequest(r)||null}async deleteItems(e,t){if(!this.db)throw new Error("Storage not initialized");const i=this.getDomainTable(e),o=this.db.transaction([i],"readwrite").objectStore(i);for(const r of t)await this.promisifyRequest(o.delete(r));await this.updateDomainMetadata(e,{item_count:await this.countItems(e)}),console.log(`🗑️ Deleted ${t.length} items from domain: ${e}`)}async clearDomain(e){if(!this.db)throw new Error("Storage not initialized");const t=this.getDomainTable(e),n=this.db.transaction([t],"readwrite").objectStore(t);await this.promisifyRequest(n.clear()),await this.updateDomainMetadata(e,{last_sync:null,item_count:0}),d(`🧹 Cleared all data for domain: ${e}`)}async storeBinaryData(e,t){if(!this.db)throw new Error("Storage not initialized");if(t.byteLength>this.config.maxSize)throw new Error(`Binary data too large: ${t.byteLength} > ${this.config.maxSize}`);const i=this.DOMAIN_TABLES.media_blob_data,o=this.db.transaction([i],"readwrite").objectStore(i);await this.promisifyRequest(o.put({id:e,data:t,stored_at:new Date().toISOString()})),d(`📦 Stored binary data: ${e} (${t.byteLength} bytes)`)}async getBinaryData(e){if(!this.db)throw new Error("Storage not initialized");const t=this.DOMAIN_TABLES.media_blob_data,o=this.db.transaction([t],"readonly").objectStore(t).get(e),r=await this.promisifyRequest(o);if(!r)return null;const a=new Date(r.stored_at);return Math.floor((Date.now()-a.getTime())/(1e3*60*60*24))>this.config.maxAge?(await this.deleteBinaryData(e),null):r.data}async deleteBinaryData(e){if(!this.db)throw new Error("Storage not initialized");const t=this.DOMAIN_TABLES.media_blob_data,n=this.db.transaction([t],"readwrite").objectStore(t);await this.promisifyRequest(n.delete(e)),d(`🗑️ Deleted binary data: ${e}`)}async getStats(){if(!this.db)throw new Error("Storage not initialized");const e={music:await this.countItems("music"),photos:await this.countItems("photos"),documents:await this.countItems("documents"),videos:await this.countItems("videos")},t=await this.calculateBinarySize(),i={music:await this.getLastSyncTime("music"),photos:await this.getLastSyncTime("photos"),documents:await this.getLastSyncTime("documents"),videos:await this.getLastSyncTime("videos")},n=t+Object.values(e).reduce((o,r)=>o+r,0)*1024;return{itemCounts:e,totalSize:n,binarySize:t,lastSyncTimes:i}}async cleanup(){console.log("🧹 Starting storage cleanup...");const e=this.config.maxAge*24*60*60*1e3,t=Date.now()-e;let i=0,n=0;if(!this.db)throw new Error("Storage not initialized");const o=this.DOMAIN_TABLES.media_blob_data,c=this.db.transaction([o],"readwrite").objectStore(o).openCursor();return new Promise((g,b)=>{c.onsuccess=w=>{const y=w.target.result;if(y){const f=y.value;new Date(f.stored_at).getTime()<t&&(n+=f.data.byteLength,i++,y.delete()),y.continue()}else console.log(`🧹 Cleanup completed: ${i} items, ${n} bytes freed`),g()},c.onerror=()=>{b(new Error(`Cleanup failed: ${c.error?.message}`))}})}setupDatabase(e){d("🔧 Setting up database schema..."),Object.entries(this.DOMAIN_TABLES).forEach(([t,i])=>{if(!e.objectStoreNames.contains(i)){const n=e.createObjectStore(i,{keyPath:"id"});switch(n.createIndex("_stored_at","_stored_at"),t){case"songs":n.createIndex("title","title"),n.createIndex("artist","artist"),n.createIndex("album","album"),n.createIndex("created_at","created_at");break;case"playlists":n.createIndex("title","title"),n.createIndex("created_at","created_at");break;case"playlist_songs":n.createIndex("playlist_id","playlist_id"),n.createIndex("song_id","song_id"),n.createIndex("position","position");break;case"media_blobs":n.createIndex("created_at","created_at"),n.createIndex("mime_type","mime_type"),n.createIndex("sha256","sha256");break}}}),e.objectStoreNames.contains(this.METADATA_STORE)||e.createObjectStore(this.METADATA_STORE,{keyPath:"domain"}),d("✅ Database schema setup complete")}async promisifyRequest(e){return new Promise((t,i)=>{e.onsuccess=()=>t(e.result),e.onerror=()=>i(e.error)})}async countItems(e){if(!this.db)return 0;if(e==="music"){const r=this.getMusicTables(),a=this.db.transaction(r,"readonly");let c=0;for(const g of r){const w=a.objectStore(g).count();c+=await this.promisifyRequest(w)}return c}const t=this.getDomainTable(e),o=this.db.transaction([t],"readonly").objectStore(t).count();return await this.promisifyRequest(o)}async calculateBinarySize(){if(!this.db)return 0;const e=this.DOMAIN_TABLES.media_blob_data,i=this.db.transaction([e],"readonly").objectStore(e);let n=0;const o=i.openCursor();return new Promise((r,a)=>{o.onsuccess=c=>{const g=c.target.result;g?(n+=g.value.data.byteLength,g.continue()):r(n)},o.onerror=()=>{a(new Error(`Failed to calculate binary size: ${o.error?.message}`))}})}async getLastSyncTime(e){const t=await this.getDomainMetadata(e);return t?.last_sync?new Date(t.last_sync):null}async updateDomainMetadata(e,t){if(!this.db)return;const n=this.db.transaction([this.METADATA_STORE],"readwrite").objectStore(this.METADATA_STORE),r={...await this.promisifyRequest(n.get(e))||{domain:e},...t};await this.promisifyRequest(n.put(r))}async getDomainMetadata(e){if(!this.db)return null;const n=this.db.transaction([this.METADATA_STORE],"readonly").objectStore(this.METADATA_STORE).get(e);return await this.promisifyRequest(n)}async destroyAll(){return d("💥 Starting complete database teardown..."),this.db&&(this.db.close(),this.db=null),new Promise((e,t)=>{const i=indexedDB.deleteDatabase(this.dbName);i.onsuccess=()=>{d("🗑️ Database completely destroyed:",this.dbName),e()},i.onerror=()=>{N("❌ Failed to destroy database:",i.error),t(new Error(`Failed to destroy database: ${i.error?.message}`))},i.onblocked=()=>{ve("⚠️ Database deletion blocked - close all tabs using this database")}})}}function Ot(s){return new Ut(s)}//! Auto-Sync Notification Router - Phase 3
//!
...
const ae={storage:{databaseName:"unified_sync_storage",version:1,maxSize:100*1024*1024,maxAge:30},autoSync:{enabled:!0,syncOnNewContent:!0,periodicInterval:30,domains:["music","photos"],debounceDelay:5e3},defaultSyncOptions:{domains:["music","photos"],forceFullSync:!1,includeBinaryData:!0,priorityOrder:["music","photos","documents","videos"]}};async function Kt(s,e,t){const i={apiBaseUrl:t.apiBaseUrl,websocketUrl:t.websocketUrl,clientId:t.clientId,authToken:t.authToken,domains:Le(),storage:{...ae.storage,...t.storageConfig},autoSync:{...ae.autoSync,domains:t.enabledDomains||ae.autoSync.domains,...t.autoSyncConfig},defaultSyncOptions:{...ae.defaultSyncOptions,domains:t.enabledDomains||ae.defaultSyncOptions.domains}},n=Ot(i.storage);await n.initialize();const o=Wt(n,s,e,i);return await o.initialize(),o}async function Xt(s,e,t){return Kt(s,e,{...t,websocketUrl:t.apiBaseUrl.replace("http","ws")+"/ws"})}const Zt="1.0.0",ei={AUTO_SYNC:!0,BINARY_CACHING:!0,SERVICE_WORKER:!0,MULTI_DOMAIN:!0,REAL_TIME_UPDATES:!0,SERVICE_WORKER_SYNC:!0,NOTIFICATION_ROUTING:!0,ENHANCED_AUTO_SYNC:!0,USER_NOTIFICATIONS:!0,RESOURCE_AWARENESS:!0,SMART_SCHEDULING:!0};async function ti(s,e,t){const i=await Xt(s,e,{apiBaseUrl:t.apiBaseUrl,clientId:t.clientId,authToken:t.authToken}),n=await Yt(i,s,{enableUserNotifications:t.enableUserNotifications??!0,enableBackgroundSync:t.enableBackgroundSync??!0,autoStart:!0});return{syncManager:i,autoSyncSystem:n}}typeof window<"u"&&(window.unifiedSyncDebug={enable:Oe,disable:Fe,configure:xt});console.log("🚀 Unified Sync System loaded:",Zt);console.log("💡 Use window.unifiedSyncDebug.enable() to enable debug logging");var ii=I("<button class=connect-button>"),ni=I("<button class=disconnect-button>Disconnect"),si=I("<div class=connection-buttons>"),oi=I("<label class=toggle-control><input type=checkbox checked disabled><span>🔔 User Notifications"),ai=I("<span>🔄 Syncing..."),ri=I("<div class=last-sync>Last sync: "),ci=I("<div class=stat-item><span class=stat-label>Batches:</span><span class=stat-value>"),li=I("<div class=stat-item><span class=stat-label>Speed:</span><span class=stat-value>"),di=I("<div class=progress-section><h3>📊 Sync Progress</h3><div class=progress-display><div class=progress-stats><div class=stat-item><span class=stat-label>Items:</span><span class=stat-value>"),ui=I("<div class=domain-status><h3>🎵 Domain Status</h3><div class=domain-grid>"),gi=I("<div class=image-grid-section><h3>🖼️ Binary Data Image Grid (<!> images)</h3><div class=image-grid>"),hi=I("<div class=log-empty>No activity yet..."),yi=I(`<div><div class=demo-header><h2>🚀 Unified Sync System Demo</h2><div class=phase-info><span class=phase-badge>Phase 4: Unified UI Demo</span><span class=version-badge>v1.0.0</span></div></div><div class=connection-section><h3>🔗 Connection Status</h3><div class=connection-controls><div class=initialization-status><span></span></div></div></div><div class=feature-toggles><h3>⚙️ Feature Controls</h3><div class=toggle-controls><label class=toggle-control><input type=checkbox><span>🔧 Service Worker Background Sync</span></label><label class=toggle-control><input type=checkbox><span>🔄 Auto-Sync on Changes</span></label><label class=toggle-control><input type=checkbox><span>🐛 Debug Logging</span></label></div></div><div class=sync-controls><h3>🎯 Unified Sync Control</h3><div class=main-controls><button></button><button class=destroy-button title="Completely destroy all IndexedDB data (for testing)">💥 Destroy All Data</button></div></div><div class=activity-log><h3>📋 Activity Log</h3><div class=log-container></div></div><div class=system-info><h3>ℹ️ System Information</h3><div class=info-grid><div class=info-item><span class=info-label>Sync Features:</span><span class=info-value></span></div><div class=info-item><span class=info-label>Client ID:</span><span class=info-value>...</span></div><div class=info-item><span class=info-label>API URL:</span><span class=info-value></span></div></div></div><style jsx>
        .unified-sync-demo {
          padding: 20px;
          max-width: 800px;
          margin: 0 auto;
      ...
      `),fi=I("<span>🚀 Sync All Domains"),mi=I("<div class=domain-progress>/"),pi=I("<div><div class=domain-name> "),bi=I("<div class=image-item><img>"),Si=I("<div class=log-entry>");function wi(s){const[e,t]=C(null),[i,n]=C(null),[o,r]=C(null),[a,c]=C(null),[g,b]=C(!1),[w,y]=C(X.Disconnected),[f,k]=C(!1),[J,q]=C(null),[te,re]=C({}),[G,de]=C({}),[vi,ue]=C(v.Never),[Y,qe]=C({totalItems:0,completedItems:0,currentBatch:0,totalBatches:0,estimatedTimeRemaining:0,bytesTransferred:0,totalBytes:0,binaryStats:null}),[ge,je]=C(s.enableServiceWorker??!0),[he,He]=C(s.enableAutoSync??!0),[ke,Qe]=C([]),[E,ye]=C(!1),[_e,De]=C(null),[fe,me]=C([]),[Ve,Ce]=C(0),[xe,Ge]=C(!1),m=l=>{const u=new Date().toLocaleTimeString();Qe(_=>[..._.slice(-9),`[${u}] ${l}`])},Je=()=>typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){const u=Math.random()*16|0;return(l=="x"?u:u&3|8).toString(16)}),Ie=()=>{const l=/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;return s.clientId&&l.test(s.clientId)?s.clientId:Je()},Te=async()=>{try{m("🚀 Initializing Unified Sync System...");const l=s.apiBaseUrl||"http://localhost:8080",u=Ie();m(`📋 Client ID: ${u}`),m(`🌐 API Base URL: ${l}`);const _=new vt(l);c(_);const j=l.replace("http","ws").replace("3001","8080")+"/ws",R=new $t({url:j,autoReconnect:!0,reconnectDelay:3e3,debug:!0});r(R);const ee=M=>{y(M),b(M===X.Connected),m(`🔗 WebSocket status: ${M}`),console.log("🐛 WebSocket status change:",{status:M,isConnected:M===X.Connected,isInitialized:f()}),M===X.Connected?(q(null),console.log("🔌 WebSocket connected - forcing UI update")):M===X.Error&&q("WebSocket connection error")};R.on("statusChange",ee),R.on("error",M=>{q(M.message),m(`❌ WebSocket error: ${M.message}`)}),s.autoConnect!==!1&&(m("🔄 Auto-connecting WebSocket..."),R.connect()),m("⚙️ Setting up unified sync manager...");const{syncManager:H,autoSyncSystem:ce}=await ti(R,_,{apiBaseUrl:l,clientId:u,enableUserNotifications:s.enableUserNotifications??!0,enableBackgroundSync:ge()});t(H),n(ce),Ye(H),he()&&(m("🔄 Enabling auto-sync..."),H.enableAutoSync()),k(!0),m("✅ Unified Sync System initialized successfully"),console.log("🐛 State after initialization:",{isInitialized:!0,isConnected:g(),isSyncing:E()}),We(()=>{const M=g(),ie=f(),ne=E();console.log("🔄 Button state check:",{connected:M,initialized:ie,syncing:ne,buttonEnabled:ie&&M&&!ne})}),m("✅ Unified Sync System initialized successfully")}catch(l){m(`❌ Initialization failed: ${l.message}`),q(l.message)}},Ye=l=>{l.on(p.SyncStarted,u=>{m(`🔄 Sync started: ${u.domains?.join(", ")||"all domains"}`),ye(!0),ue(v.InProgress)}),l.on(p.SyncProgress,u=>{re(l.getStatus()),de(l.getProgress()),qe(u.overallProgress),u.domain&&m(`📊 ${u.domain}: ${u.progress.completedItems}/${u.progress.totalItems} items`)}),l.on(p.SyncCompleted,u=>{m(`✅ Sync completed: ${u.domains?.join(", ")||"all domains"}`),ye(!1),De(new Date),ue(v.Completed),u.stats&&m(`📈 Stats: ${u.stats.totalItems} items, ${Math.round(u.stats.totalTime/1e3)}s`),Ce(_=>_+1),u.stats&&u.stats.binaryStats?.cached>0&&(m("🖼️ Binary sync completed, checking for images..."),setTimeout(()=>{pe()},2e3))}),l.on(p.SyncFailed,u=>{m(`❌ Sync failed: ${u.error.message}`),ye(!1),ue(v.Failed)}),l.on(p.AutoSyncTriggered,u=>{m(`🔔 Auto-sync triggered: ${u.reason} (${u.domains?.join(", ")||"all domains"})`)}),l.on(p.ConnectionChanged,u=>{m(`🔗 Connection ${u.connected?"established":"lost"}`)}),l.on(p.BinarySyncProgress,u=>{if(u.stats){const{completed:_,total:j,speed:R}=u.stats;m(`📁 Binary sync: ${_}/${j} files (${Math.round(R/1024)}KB/s)`)}})},Ke=async()=>{const l=e();if(!(!l||E()))try{m("🚀 Starting unified sync for all domains...");const u=await l.syncAll({domains:["music","photos"],includeBinaryData:!0,forceFullSync:!1});m(`✨ Sync completed! Synced domains: ${u.syncedDomains?.join(", ")||"none"}`)}catch(u){m(`❌ Sync failed: ${u.message}`)}},Xe=async()=>{const l=!ge();if(je(l),m(`🔧 Service Worker ${l?"enabled":"disabled"}`),e()&&i()){const _=i();_.setBackgroundSyncEnabled&&await _.setBackgroundSyncEnabled(l)}},Ze=async()=>{const l=!he();He(l);const u=e();u&&(l?(m("🔄 Enabling auto-sync..."),u.enableAutoSync()):m("⏸️ Auto-sync disabled"))},et=async()=>{const l=e();if(!(!l||E()))try{m("💥 Starting complete database teardown..."),k(!1),De(null),me([]),Ce(0),await l.destroyAll(),m("🗑️ Database completely destroyed!"),t(null),n(null),m("🔄 Reinitializing system..."),await Te(),m("✅ System reinitialized successfully!")}catch(u){m(`❌ Teardown failed: ${u.message}`),console.error("Destroy error:",u)}},pe=async()=>{const l=e();if(!(!l||!f()))try{const u=(await l.getMediaBlobs()).slice(0,100);if(u.length===0){me([]);return}m(`📷 Found ${u.length} image blobs, checking binary data...`);const _=[];let j=0;for(const R of u)try{if(await l.hasBinaryData(R.id)){j++;const H=await l.getBlobUrl(R.id);H&&_.push(H)}}catch{continue}_.length>0?(me(_),m(`🎨 Image grid loaded: ${_.length} images (${j} with binary data)`)):j===0&&u.length>0&&m(`📷 Found ${u.length} image metadata but no binary data yet`)}catch(u){m(`❌ Failed to load image grid: ${u.message}`)}};We(()=>{const l=e(),u=f();if(Ve(),l&&u){pe();const _=setInterval(()=>{pe()},3e3);setTimeout(()=>{clearInterval(_)},3e4)}});const tt=()=>{const l=o();l&&!g()&&(m("🔄 Connecting WebSocket..."),l.connect())},it=()=>{const l=!xe();Ge(l),l?(Oe(),m("🐛 Debug logging enabled")):(Fe(),m("🔇 Debug logging disabled"))},nt=()=>{const l=o();l&&g()&&(m("🔌 Disconnecting WebSocket..."),l.disconnect())};bt(()=>{Te()}),St(()=>{const l=o(),u=e();l&&l.disconnect(),u&&u.destroy()});const Z=()=>{const l=Y();return{percentage:l.totalItems>0?Math.round(l.completedItems/l.totalItems*100):0,itemsText:`${l.completedItems}/${l.totalItems} items`,batchText:l.totalBatches>0?`Batch ${l.currentBatch}/${l.totalBatches}`:"",etaText:l.estimatedTimeRemaining>0?`ETA: ${Math.round(l.estimatedTimeRemaining/1e3)}s`:"",speedText:l.binaryStats?.speed?`${Math.round(l.binaryStats.speed/1024)}KB/s`:""}};return(()=>{var l=yi(),u=l.firstChild,_=u.nextSibling,j=_.firstChild,R=j.nextSibling,ee=R.firstChild,H=ee.firstChild,ce=_.nextSibling,M=ce.firstChild,ie=M.nextSibling,ne=ie.firstChild,be=ne.firstChild,Me=ne.nextSibling,Se=Me.firstChild,st=Me.nextSibling,Ae=st.firstChild,Ne=ce.nextSibling,ot=Ne.firstChild,Ee=ot.nextSibling,se=Ee.firstChild,W=se.nextSibling,oe=Ne.nextSibling,at=oe.firstChild,Re=at.nextSibling,rt=oe.nextSibling,ct=rt.firstChild,lt=ct.nextSibling,Be=lt.firstChild,dt=Be.firstChild,ut=dt.nextSibling,Pe=Be.nextSibling,gt=Pe.firstChild,ze=gt.nextSibling,ht=ze.firstChild,yt=Pe.nextSibling,ft=yt.firstChild,mt=ft.nextSibling;return S(R,x(z,{get when(){return o()},get children(){return[x(Dt,{get status(){return w()},showText:!0,compact:!0}),(()=>{var h=si();return S(h,x(z,{get when(){return!g()},get children(){var $=ii();return $.$$click=tt,S($,()=>w()===X.Connecting?"Connecting...":"Connect"),K(()=>$.disabled=w()===X.Connecting),$}}),null),S(h,x(z,{get when(){return g()},get children(){var $=ni();return $.$$click=nt,$}}),null),h})()]}}),ee),S(H,()=>f()?"✅ Initialized":"⏳ Initializing..."),be.addEventListener("change",Xe),Se.addEventListener("change",Ze),Ae.addEventListener("change",it),S(ie,x(z,{get when(){return s.enableUserNotifications!==!1},get children(){return oi()}}),null),se.$$click=()=>{console.log("🐛 Button click - Debug state:",{isInitialized:f(),isConnected:g(),isSyncing:E(),buttonDisabled:!f()||!g()||E()}),Ke()},S(se,x(z,{get when(){return E()},get fallback(){return fi()},get children(){return ai()}})),W.$$click=et,W.style.setProperty("background-color","#dc3545"),W.style.setProperty("color","white"),W.style.setProperty("border","none"),W.style.setProperty("padding","10px 20px"),W.style.setProperty("border-radius","5px"),W.style.setProperty("margin-left","10px"),S(Ee,x(z,{get when(){return _e()},get children(){var h=ri();return h.firstChild,S(h,()=>_e()?.toLocaleTimeString(),null),h}}),null),S(l,x(z,{get when(){return E()||Y().totalItems>0},get children(){var h=di(),$=h.firstChild,Q=$.nextSibling,T=Q.firstChild,V=T.firstChild,B=V.firstChild,O=B.nextSibling;return S(Q,x(kt,{get progress(){return Z().percentage},get itemsSynced(){return Y().completedItems},get totalItems(){return Y().totalItems},get currentBatch(){return Y().currentBatch},get totalBatches(){return Y().totalBatches},get eta(){return Y().estimatedTimeRemaining},showDetails:!0,className:"unified-progress"}),T),S(O,()=>Z().itemsText),S(T,x(z,{get when(){return Z().batchText},get children(){var P=ci(),D=P.firstChild,F=D.nextSibling;return S(F,()=>Z().batchText),P}}),null),S(T,x(z,{get when(){return Z().speedText},get children(){var P=li(),D=P.firstChild,F=D.nextSibling;return S(F,()=>Z().speedText),P}}),null),h}}),oe),S(l,x(z,{get when(){return Object.keys(te()).length>0},get children(){var h=ui(),$=h.firstChild,Q=$.nextSibling;return S(Q,x(we,{get each(){return Object.entries(te())},children:([T,V])=>(()=>{var B=pi(),O=B.firstChild,P=O.firstChild;return S(O,T==="music"?"🎵":T==="photos"?"📸":"📁",P),S(O,T,null),S(B,x(_t,{status:V,compact:!0}),null),S(B,x(z,{get when(){return G()[T]},get children(){var D=mi(),F=D.firstChild;return S(D,()=>G()[T].completedItems,F),S(D,()=>G()[T].totalItems,null),D}}),null),K(()=>le(B,`domain-card ${V.toLowerCase()}`)),B})()})),h}}),oe),S(l,x(z,{get when(){return fe().length>0},get children(){var h=gi(),$=h.firstChild,Q=$.firstChild,T=Q.nextSibling;T.nextSibling;var V=$.nextSibling;return S($,()=>fe().length,T),S(V,x(we,{get each(){return fe()},children:(B,O)=>(()=>{var P=bi(),D=P.firstChild;return D.addEventListener("error",F=>{console.log(`Failed to load image ${O()+1}:`,B),F.target.style.display="none"}),Ue(D,"src",B),D.style.setProperty("width","100px"),D.style.setProperty("height","100px"),D.style.setProperty("object-fit","cover"),D.style.setProperty("border","1px solid #ddd"),D.style.setProperty("border-radius","4px"),K(()=>Ue(D,"alt",`Image ${O()+1}`)),P})()})),h}}),oe),S(Re,x(we,{get each(){return ke().slice().reverse()},children:h=>(()=>{var $=Si();return S($,h),$})()}),null),S(Re,x(z,{get when(){return ke().length===0},get children(){return hi()}}),null),S(ut,()=>Object.entries(ei).filter(([h,$])=>$).map(([h,$])=>h).join(", ")),S(ze,()=>Ie().slice(0,8),ht),S(mt,()=>s.apiBaseUrl||"http://localhost:8080"),K(h=>{var $=`unified-sync-demo ${s.className||""}`,Q=`status-indicator ${f()?"success":"pending"}`,T=!f(),V=!f(),B=`sync-all-button ${E()?"syncing":""}`,O=!f()||!g()||E(),P=!f()||E(),D=!f()||E()?"not-allowed":"pointer",F=!f()||E()?"0.5":"1";return $!==h.e&&le(l,h.e=$),Q!==h.t&&le(H,h.t=Q),T!==h.a&&(be.disabled=h.a=T),V!==h.o&&(Se.disabled=h.o=V),B!==h.i&&le(se,h.i=B),O!==h.n&&(se.disabled=h.n=O),P!==h.s&&(W.disabled=h.s=P),D!==h.h&&((h.h=D)!=null?W.style.setProperty("cursor",D):W.style.removeProperty("cursor")),F!==h.r&&((h.r=F)!=null?W.style.setProperty("opacity",F):W.style.removeProperty("opacity")),h},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0}),K(()=>be.checked=ge()),K(()=>Se.checked=he()),K(()=>Ae.checked=xe()),l})()}wt("unified-sync-demo",{apiBaseUrl:void 0,clientId:void 0,autoConnect:!0,enableServiceWorker:!0,enableAutoSync:!0,className:"",enableUserNotifications:!0},wi);pt(["click"]);
