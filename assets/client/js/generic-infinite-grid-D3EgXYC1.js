import{f as Y,r as Z,g as p,c as E,k as d,o as q,b as K,t as u,i as l,S as Q,d as S,F as H,e as D,j as P,u as X}from"./web-DJKfNvYW.js";var ee=u("<span>"),te=u("<div><style></style><div class=grid-header></div><div class=grid-viewport><div class=grid-content></div></div><div class=grid-stats>Showing rows <!>-<!> of "),re=u("<span class=sort-icon>"),ie=u("<div><span class=header-title>"),ne=u("<div class=grid-row>"),oe=u("<div class=grid-cell>");console.log("🚀 Generic Infinite Grid script loading");function le(t){console.log("📦 GenericInfiniteGrid component created");const o=()=>t.rowHeight||50,h=()=>t.headerHeight||60,v=5,[b,w]=E(0),[x,m]=E(window.innerHeight);E(0);let y;const T=d(()=>{const e=x()-h();return Math.ceil(e/o())}),k=d(()=>t.data.length),G=d(()=>{const e=Math.floor(b()/o());return Math.max(0,e-v)}),N=d(()=>{const e=G()+T()+v*2;return Math.min(k(),e)}),M=d(()=>Math.floor(b()/o())+1),C=d(()=>{const e=x()-h(),s=Math.floor(e/o()),c=Math.floor(b()/o())+s;return Math.min(c,k())});d(()=>Math.max(0,C()-M()+1));const V=d(()=>t.data.slice(G(),N())),L=d(()=>k()*o()),O=e=>{const s=e.target;w(s.scrollTop)},j=e=>{if(!t.onSort)return;const c=(t.sortField===e?t.sortDirection:"asc")==="asc"?"desc":"asc";t.onSort(e,c)},R=()=>{m(window.innerHeight)};q(()=>{window.addEventListener("resize",R)}),K(()=>{window.removeEventListener("resize",R)});const B=e=>t.sortField!==e?"⇅":t.sortDirection==="asc"?"↑":"↓",J=(e,s)=>{const c=e.getValue?e.getValue(s):s[e.key];return e.render?e.render(s,c):(()=>{var g=ee();return l(g,()=>String(c)),g})()};return(()=>{var e=te(),s=e.firstChild,c=s.nextSibling,g=c.nextSibling,_=g.firstChild,$=g.nextSibling,U=$.firstChild,z=U.nextSibling,W=z.nextSibling,A=W.nextSibling;A.nextSibling,l(s,()=>`
